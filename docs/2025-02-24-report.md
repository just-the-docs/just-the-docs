...
##### ['postgres_scanner', 'aws', 'azure', 'spatial', 'iceberg', 'tpch', 'mysql_scanner', 'inet', 'excel', 'sqlite_scanner', 'vss', 'httpfs', 'tpcds', 'fts', 'arrow']
...
#### Tested extensions
The following extensions could be loaded and installed successfully:
##### ['spatial', 'postgres_scanner', 'mysql_scanner', 'azure', 'aws', 'iceberg', 'sqlite_scanner', 'excel', 'inet', 'arrow', 'tpcds', 'httpfs', 'fts', 'vss', 'autocomplete']
#### List of failed extensions:
...
#### Tested extensions
The following extensions could be loaded and installed successfully:
##### ['arrow', 'vss', 'httpfs', 'fts', 'tpcds', 'aws', 'azure', 'mysql_scanner', 'tpch', 'iceberg', 'spatial', 'postgres_scanner', 'inet', 'delta', 'sqlite_scanner', 'excel']
...
#### Tested extensions
The following extensions could be loaded and installed successfully:
##### ['aws', 'iceberg', 'spatial', 'azure', 'mysql_scanner', 'postgres_scanner', 'sqlite_scanner', 'inet', 'excel', 'fts', 'autocomplete', 'arrow', 'vss', 'tpcds', 'httpfs']
#### List of failed extensions:

| nightly_build   | architecture   | runs_on          | version   | extension   | statement   | result   |
|:----------------|:---------------|:-----------------|:----------|:------------|:------------|:---------|
| python          | arm64          | ubuntu-22.04-arm |           | httpfs      | INSTALL     | failed   |
...
#### Tested extensions
The following extensions could be loaded and installed successfully:
##### ['sqlite_scanner', 'inet', 'delta', 'excel', 'aws', 'iceberg', 'postgres_scanner', 'mysql_scanner', 'spatial', 'azure', 'tpch', 'vss', 'arrow', 'tpcds', 'httpfs', 'fts']
None of extensions had failed to be installed or loaded.
...
#### Tested extensions
The following extensions could be loaded and installed successfully:
##### ['tpcds', 'vss', 'arrow', 'httpfs', 'fts', 'mysql_scanner', 'tpch', 'aws', 'azure', 'spatial', 'postgres_scanner', 'iceberg', 'sqlite_scanner', 'delta', 'excel', 'inet']
None of extensions had failed to be installed or loaded.
