...
کوچ نه تنها تشخیص { bg-grey-lt-000 fs-4 | راستی } و `صداقت` را در رابطه با خود و مراجع می‌دهد، بلکه تشخیص می‌دهد که این ویژگی‌ها باید در رابطه با **حامیان** و **ذینفعان** نیز وجود داشته باشد. کوچ به **سطح صداقت**، **حرفه‌ای بودن** و **تمامیت** خود توجه دارد. آن جایی که الان هست و جایی که در آینده قصد دارد برسد را در نظر می‌گیرد [از نظر سطح حرفه‌ی خود کوچ].
