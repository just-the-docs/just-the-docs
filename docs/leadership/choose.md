...
{ **وقتی چیزی برای انتخاب ندارید**، می‌توانید **آنچه که هست** را انتخاب کنید. می‌توانید **وضعیت فعلی** را انتخاب کنید. می‌توانید **آنچه در مقابلتان است** را انتخاب کنید. می‌توانید **آنچه اکنون در دسترس شما است** را انتخاب کنید. می‌توانید **آنچه دارید** را انتخاب کنید. | mark }
