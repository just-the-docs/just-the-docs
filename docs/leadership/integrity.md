...
زمانی که "تمامیت" به عنوان یک اصطلاح مورد بررسی قرار می‌گیرد، نه با یک مورد واقعی از تمامیت و نه با حوزه تمامیت سر و کار داریم. به جای آن، با تعریفی از تمامیت سر و کار داریم. همانطور که در زیر خواهیم دید، با گرفتن آنها به عنوان اصطلاحات (در حالی که از تعاریف موجود واژه‌نامه استفاده می‌کنیم اما از جملاتی در تعاریف که همپوشانی دارند پرهیز می‌کنیم)، ما تعاریف منحصر به فردی برای هر یک از تمامیت، اخلاقیات، اصول اخلاقی و قوانین ایجاد می‌کنیم. بنابراین:

1) در چارچوب متنی ما، با اختصاص دادن هر یک از چهار پدیده به یکی از دو حوزه متمایز، یعنی یک حوزه مثبت بدون ارزش‌های نرماتیو و یک حوزه نرماتیو از فضایل، شروع می‌کنیم. در مدل جدید ما، تمامیت در حوزه مثبت وجود دارد، در حالی که اخلاقیات، اصول اخلاقی و قوانین در حوزه نرماتیو از فضایل وجود دارند.

2) سپس، در حوزه‌های مربوط به خود، جنبه دوم چارچوب متنی ما با تشخیص حوزه‌های غیر همپوشان، متمایز و جداگانه برای هر یک از چهار مفهوم ایجاد می‌شود. ما حوزه اخلاقیات را به عنوان یک حوز

ه فضیلت اجتماعی، حوزه اصول اخلاقی را به عنوان یک حوزه فضیلت گروهی و حوزه قوانین را به عنوان یک حوزه فضیلت دولتی تشخیص می‌دهیم. ما حوزه تمامیت را به عنوان وضعیت یا شرایط هدفمند یک شیء، سیستم، فرد، گروه، سازمان یا جامعه تشخیص می‌دهیم.

3) و در نهایت، در حوزه‌های مربوط به خود، جنبه آخر چارچوب متنی ما با ارائه تعاریف منحصر به فرد برای هر یک از چهار اصطلاح ایجاد می‌شود تا هیچ گونه سردرگمی، اشتباه یا ابهامی بین آنها وجود نداشته باشد. ما این تعاریف را در بخش 2 زیر ارائه می‌دهیم.
...
1) به عنوان پدیده‌ها، همه چهار به حوزه نرماتیو فرو می‌روند، و بدین ترتیب:

a) قدرت تمامیت به عنوان بنیاد عملکرد که زمانی که تمامیت به عنوان یک پدیده مثبت مورد بررسی قرار می‌گیرد، آشکار می‌شود، از دست می‌رود، و

b) قدرت تمامیت، زمانی که به عنوان یک پدیده مثبت مورد بررسی قرار می‌گیرد، برای افزایش تأثیر واقعی بر رفتار از پدیده‌های فضیلت نرماتیو اخلاقیات، اصول اخلاقی و قوانین از دست می‌رود.
...
در خلاصه، فرو رفتن همه چهار پدیده به حوزه نرماتیو، و همپوشانی حوزه‌های هر یک به عنوان مفاهیم، و سردرگمی و اشتباه تعاریف هر یک به عنوان اصطلاحات، قدرت مخصوص به هر یک از عناصر را از دست می‌دهد. به طور جمعی، این منجر به تجزیه و تحلیل ناکارآمد و غیر دقیق، شعارهای بی‌محتوا، و سیاست‌ها و ارزش‌هایی می‌شود که اعلام می‌شوند اما رعایت نمی‌شوند.
