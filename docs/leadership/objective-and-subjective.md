...
2. **درون‌آخته [هستی‌شناسانه](../ontology-and-phenomenology)** (Ontologically Subjective): چیزهایی که در آگاهی یا هویت فردی وجود دارند، مانند درد شدید در پا یا عشق به همسر.
...
4. **برون‌آخته [هستی‌شناسانه](../ontology-and-phenomenology)** (Ontologically Objective): چیزهایی که وجود دارند بدون نیاز به هویت یا آگاهی از آن‌ها.  
