...
Syntax highlighting, line numbers, and HTML compression do not work together; **the combination of these features generates invalid HTML**. To learn more, see ["Code with line numbers"]({% link docs/ui-components/line-nos.md %}).
