...
1. اولاً، «هستی»، «کلی‌»ترین مفهوم است:
...
در فلسفهٔ باستانی "هستی" به عنوان یک "ترانسندنتال"[^3] نام‌برده شده است. ارسطو خود وحدت این "کلیت ترانسندنتال" را به عنوان یک وحدت تمثیل در مقابل تعدد مفاهیم جنسی بالاترین چیزها می‌شناخت. با این کشف، با وابستگی به شیوه‌ای که سوال انطولوژیک توسط افلاطون ترتیب داده شده بود، مسئله هستی را بر اساس یک اصل جدید قرار داد. البته، حتی ارسطو هم نتوانست تاریکی این ارتباطات دسته‌بندی را پاک کند. در فلسفهٔ باستانی این مسئله به طور گسترده‌ای مورد بحث قرار گرفت، به ویژه در مدارس توماسی و اسکاتی، بدون اینکه در مورد اصول وضوحی به دست آورد. و زمانی که هگل در نهایت "هستی" را به عنوان "فوری نامعین"[^4] تعریف می‌کند و این تعریف را برای تمام توضیحات دسته‌بندی بعدی "منطق" خود اساسی می‌کند، او همچنان به همان جهت فلسفهٔ باستانی نگاه می‌کند، به جز اینکه دیگر به مسئله ارسطو در مورد وحدت هستی در مقابل تعدد "دسته‌بندی‌ها" که به چیزها قابل اجرا است، توجه نمی‌کند. بنابراین، اگر گفته شود که "هستی" مفهوم بیشترین کلیت است، این به این معنی نیست که این واضح‌ترین است یا نیازی به بحث بیشتر ندارد. بلکه تاریک‌ترین است.

{: .highlight }
> این قسمت از متن به بررسی مفهوم "هستی" در فلسفه باستانی و نحوه تفسیر و تعریف آن توسط فلاسفه مختلف می‌پردازد. در زیر خلاصه‌ای از موارد اصلی مطرح شده در این قسمت ارائه می‌شود:
>
> 1. **ترانسندنتال در فلسفه باستانی**: در فلسفه باستان، "هستی" به عنوان یک "ترانسندنتال" یعنی چیزی فراتر از تجربه حسی و محدودیت‌های آن، توصیف شده است.
> 2. **نظر ارسطو**: ارسطو مفهوم "هستی" را به عنوان یک "کلیت ترانسندنتال" می‌شناسد که وحدتی تمثیلی دارد و فراتر از مفاهیم جنسی (یعنی دسته‌بندی‌های عمومی) قرار دارد.
> 3. **تأثیر افلاطون**: ارسطو، با وجود تأثیراتی که از افلاطون بر او وارد شده بود، مسئله "هستی" را بر اساس یک اصل جدید قرار داد.
> 4. **بحران در فلسفه باستانی**: مسئله "هستی" در فلسفه باستان به طور گسترده‌ای مورد بحث قرار گرفت، اما به وضوح و قطعیتی نرسید.
> 5. **نظر هگل**: هگل "هستی" را به عنوان یک "فوری نامعین" تعریف کرد. او با این تعریف، همچنان در مسیر فلسفه باستانی حرکت می‌کرد، اما به مسئله وحدت "هستی" که ارسطو مطرح کرده بود، توجه نمی‌کرد.
> 6. **تاریکی مفهوم هستی**: اگرچه "هستی" به عنوان مفهومی با کلیت بالا شناخته می‌شود، اما این به این معنی نیست که واضح یا ساده است. در واقع، این مفهوم یکی از پیچیده‌ترین و تاریک‌ترین مفاهیم فلسفی است.
>
> در کل، این قسمت از متن به بررسی تاریخچه و تفسیر مفهوم "هستی" در فلسفه و نحوه تعریف و تفسیر آن توسط فلاسفه مختلف می‌پردازد.

[^3]: واژه "ترانسندنتال" به معنایی خاص و متمایز از کاربردهای دیگری که در فلسفه برای آن وجود دارد، استفاده می‌شود. در این کتاب، هایدگر به بررسی طبیعت "هستی" و چگونگی "زمان" می‌پردازد. او به دنبال فهمیدن این است که چرا موجودات هستند و چگونه آن‌ها هستند. در این راستا، او به بررسی تجربیات پایه‌ای و پیش‌فرض‌هایی می‌پردازد که ذهن انسان برای درک و تفسیر جهان به آن‌ها نیاز دارد. واژه "ترانسندنتال" در این کتاب به این مفاهیم و شرایط پیش‌فرضی اشاره دارد. به عبارت دیگر، هایدگر به دنبال فهمیدن این است که چه چیزی باعث می‌شود ما به گونه‌ای خاص جهان را تجربه کنیم و چگونه ما به مفهوم "هستی" یا "وجود" فکر می‌کنیم. در این مفهوم، "ترانسندنتال" به مفاهیم و شرایط پایه‌ای اشاره دارد که ذهن انسان برای درک و تفسیر تجربیات حسی و معنایی خود به آن‌ها نیاز دارد. این مفاهیم و شرایط پیش‌فرضی هستند که بدون آن‌ها تجربه و درک جهان امکان‌پذیر نیست.
