...
با توجه به پیش‌فرض‌ها و تعصباتی که به طور مداوم باور به اینکه پرسش در مورد هستی غیرضروری است را مجدداً بیان و تقویت می‌کنند، به این سوال باید طور جدی و دقیق باید بررسی شود. اینها در خود فلسفهٔ باستانی ریشه دارند و تا زمانی که سوال هستی به طور کامل و روشن پاسخ داده نشود، تفسیر مناسبی از این فلسفه ممکن نخواهد بود. حداقل اگر می‌خواهیم به منشاء[^1] که از آن مفاهیم انطولوژیک پایه‌ای توسعه یافته است توجه کنیم و ببینیم آیا دسته‌بندی‌ها[^1] به شکل مناسب و کامل اثبات شده‌اند یا خیر. بنابراین، ما بحث در مورد این پیش‌فرض‌ها[^2] را فقط به نقطه‌ای خواهیم برد که ضرورت مطرح مجدد سوال در مورد معنای هستی واضح شود. سه پیش‌فرض چنین وجود دارد.
