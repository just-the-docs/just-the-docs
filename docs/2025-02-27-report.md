...
| failure      | [2025-02-13 00:33:39](https://github.com/duckdb/duckdb/actions/runs/13297749977) |
...
> 'spatial', 'aws', 'mysql_scanner', 'azure', 'tpch', 'iceberg', 'postgres_scanner', 'httpfs', 'arrow', 'vss', 'tpcds', 'fts', 'sqlite_scanner', 'inet', 'excel'
...
## python_amd64
#### Tested extensions:
> 'aws', 'extension', 'excel', 'sqlite_scanner', 'azure', 'version', 'inet', 'postgres_scanner', 'result', 'nightly_build', 'vss', 'fts', 'delta', 'architecture', 'iceberg', 'statement', 'mysql_scanner', 'autocomplete', 'tpcds', 'arrow', 'runs_on', 'spatial', 'httpfs'
...
| nightly_build   | architecture   | runs_on      | extension        | statement   |
|:----------------|:---------------|:-------------|:-----------------|:------------|
| windows         | amd64          | windows-2019 | excel            | INSTALL     |
| windows         | amd64          | windows-2019 | excel            | LOAD        |
| windows         | amd64          | windows-2019 | tpcds            | INSTALL     |
| windows         | amd64          | windows-2019 | tpcds            | LOAD        |
| windows         | amd64          | windows-2019 | arrow            | INSTALL     |
| windows         | amd64          | windows-2019 | arrow            | LOAD        |
| windows         | amd64          | windows-2019 | tpch             | INSTALL     |
| windows         | amd64          | windows-2019 | tpch             | LOAD        |
| windows         | amd64          | windows-2019 | postgres_scanner | INSTALL     |
| windows         | amd64          | windows-2019 | postgres_scanner | LOAD        |
| windows         | amd64          | windows-2019 | spatial          | INSTALL     |
| windows         | amd64          | windows-2019 | spatial          | LOAD        |
| windows         | amd64          | windows-2019 | sqlite_scanner   | INSTALL     |
| windows         | amd64          | windows-2019 | sqlite_scanner   | LOAD        |
| windows         | amd64          | windows-2019 | delta            | INSTALL     |
| windows         | amd64          | windows-2019 | delta            | LOAD        |
| windows         | amd64          | windows-2019 | iceberg          | INSTALL     |
| windows         | amd64          | windows-2019 | iceberg          | LOAD        |
| windows         | amd64          | windows-2019 | mysql_scanner    | INSTALL     |
| windows         | amd64          | windows-2019 | mysql_scanner    | LOAD        |
| windows         | amd64          | windows-2019 | azure            | INSTALL     |
| windows         | amd64          | windows-2019 | azure            | LOAD        |
| windows         | amd64          | windows-2019 | vss              | INSTALL     |
| windows         | amd64          | windows-2019 | vss              | LOAD        |
| windows         | amd64          | windows-2019 | inet             | INSTALL     |
| windows         | amd64          | windows-2019 | inet             | LOAD        |
| windows         | amd64          | windows-2019 | aws              | INSTALL     |
| windows         | amd64          | windows-2019 | aws              | LOAD        |
| windows         | amd64          | windows-2019 | httpfs           | INSTALL     |
| windows         | amd64          | windows-2019 | httpfs           | LOAD        |
| windows         | amd64          | windows-2019 | fts              | INSTALL     |
| windows         | amd64          | windows-2019 | fts              | LOAD        |
