...
> ['tpcds', 'vss', 'httpfs', 'arrow', 'fts', 'mysql_scanner', 'iceberg', 'azure', 'tpch', 'aws', 'spatial', 'postgres_scanner', 'excel', 'sqlite_scanner', 'inet']
...
## windows_amd64
#### The following extensions could be loaded and installed successfully:
> ['httpfs', 'tpcds', 'fts', 'arrow', 'vss', 'delta', 'inet', 'sqlite_scanner', 'excel', 'spatial', 'postgres_scanner', 'azure', 'aws', 'mysql_scanner', 'tpch', 'iceberg']
...
## osx_amd64
#### The following extensions could be loaded and installed successfully:
> ['iceberg', 'mysql_scanner', 'tpch', 'azure', 'postgres_scanner', 'spatial', 'aws', 'inet', 'sqlite_scanner', 'excel', 'delta', 'tpcds', 'httpfs', 'vss', 'arrow', 'fts']

#### All extensions had been successfully installed and loaded.

## osx_arm64
#### The following extensions could be loaded and installed successfully:
> ['sqlite_scanner', 'inet', 'delta', 'excel', 'postgres_scanner', 'azure', 'aws', 'tpch', 'spatial', 'mysql_scanner', 'iceberg', 'arrow', 'fts', 'vss', 'httpfs', 'tpcds']
