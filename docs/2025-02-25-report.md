...
|:-------------|:---------------------------------------------------------------------------------|
|              | [2025-02-25 17:14:00](https://github.com/duckdb/duckdb/actions/runs/13526963336) |
...
> ['inet', 'sqlite_scanner', 'excel', 'aws', 'iceberg', 'postgres_scanner', 'azure', 'tpch', 'spatial', 'mysql_scanner', 'vss', 'arrow', 'httpfs', 'tpcds', 'fts']
...
## python_amd64
#### Tested extensions:
> 'sqlite_scanner', 'iceberg', 'arrow', 'extension', 'statement', 'spatial', 'httpfs', 'inet', 'vss', 'version', 'azure', 'postgres_scanner', 'nightly_build', 'result', 'runs_on', 'fts', 'mysql_scanner', 'excel', 'autocomplete', 'architecture', 'aws', 'tpcds'
...
| python          | amd64          | ubuntu-latest |      3.8  | httpfs      | INSTALL     | failed   |
...
## windows_amd64
#### The following extensions could be loaded and installed successfully:
> ['httpfs', 'tpcds', 'fts', 'arrow', 'vss', 'tpch', 'iceberg', 'postgres_scanner', 'azure', 'spatial', 'aws', 'mysql_scanner', 'delta', 'inet', 'excel', 'sqlite_scanner']
...
## python_arm64
#### Tested extensions:
> 'sqlite_scanner', 'iceberg', 'arrow', 'extension', 'statement', 'spatial', 'httpfs', 'inet', 'vss', 'version', 'azure', 'postgres_scanner', 'nightly_build', 'result', 'runs_on', 'autocomplete', 'fts', 'mysql_scanner', 'excel', 'architecture', 'aws', 'tpcds'
...
| python          | arm64          | ubuntu-22.04-arm |      3.11 | aws         | INSTALL     | failed   |
...
## osx_amd64
#### The following extensions could be loaded and installed successfully:
> ['excel', 'sqlite_scanner', 'inet', 'delta', 'aws', 'postgres_scanner', 'tpch', 'mysql_scanner', 'spatial', 'azure', 'iceberg', 'arrow', 'vss', 'httpfs', 'tpcds', 'fts']

#### All extensions had been successfully installed and loaded.

## osx_arm64
#### The following extensions could be loaded and installed successfully:
> ['tpch', 'postgres_scanner', 'iceberg', 'spatial', 'mysql_scanner', 'azure', 'aws', 'sqlite_scanner', 'excel', 'inet', 'delta', 'vss', 'arrow', 'fts', 'tpcds', 'httpfs']
