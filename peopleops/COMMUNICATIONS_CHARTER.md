...
![Slack Notification Setting](recommended-slack-setting.png)
  ...
  - Slack is ok for reminders about tasks, but isn't meant for assigning
    something critical, especially to the whole company. Use Trello +
    email for that.
...
### Guidelines Around Feedback
  ...
  - It's not about who's right. The process of talking about performance
    and how do things improves everyone's work and helps us work
    together constructively. So don't stress. If you can give and
...
about it."
  ...
  - It's also ok to be subtle. Especially if you're not sure what the
    ...
    and then ask "Does that really work?" "I never thought of doing it
    that way, do you prefer it to my way?". When you question something
    out of genuine curiousity, the person will stop and do the same,
    without being offended. They may not change the behaviour right away
    but it helps more than you think.
