...
### Environment
  ...
  - devs only - Read about our [DevOps](https://github.com/countable-web/ops/blob/master/devops/DEVOPS.md) and
    [Coding Standards](https://github.com/countable-web/ops/blob/master/developers/CODING_STANDARDS.md)
  - devs only - Complete the [Training](https://github.com/countable-web/ops/blob/master/developers/TRAINING.md) following these practices and get a team member to code review it using a feature branch and pull request.
...
Skim this so you know the language and how we work: [Project Management](https://github.com/countable-web/ops/blob/master/operations/PROJECT_MANAGEMENT.md).
