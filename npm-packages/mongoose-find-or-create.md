---
layout: default
npm_package_name: mongoose-find-or-create
npm_package_version: v1.3.1
npm_package_last_updated_on: Latest version published 4 years ago
npm_package_description: A plugin for Mongoose which adds the findOrCreate method to models. The method will either append an existing object or save a new one, depending on wether it finds it or not.
github_link: https://github.com/mtimofiiv/mongoose-findorcreate
repo_name: mongoose-findorcreate
npm_link: https://www.npmjs.com/package/mongoose-find-or-create
install_command: npm install mongoose-find-or-create
popularity_dependents: 1
popularity_github_stars: 21
popularity_forks: 5
