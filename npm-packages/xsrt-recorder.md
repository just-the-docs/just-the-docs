---
layout: default
npm_package_name: xsrt-recorder
npm_package_version: v0.9.1
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: The client-side recorder for XSRT
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/@xsrt/recorder
install_command: npm install @xsrt/recorder
