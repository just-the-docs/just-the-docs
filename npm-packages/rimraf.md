---
layout: default
npm_package_name: rimraf
npm_package_version: v3.0.2
npm_package_last_updated_on: Latest version published 2 years ago
npm_package_description: A deep deletion module for node (like `rm -rf`)
github_link: https://github.com/isaacs/rimraf
repo_name: rimraf
npm_link: https://www.npmjs.com/package/rimraf
install_command: npm install rimraf
popularity_dependents: 123.07K
popularity_github_stars: 4.49K
popularity_forks: 235
