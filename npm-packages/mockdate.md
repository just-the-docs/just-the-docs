---
layout: default
npm_package_name: mockdate
npm_package_version: v3.0.5
npm_package_last_updated_on: Latest version published 8 months ago
npm_package_description: A JavaScript mock Date object that can be used to change when "now" is.
github_link: https://github.com/boblauer/MockDate
repo_name: MockDate
npm_link: https://www.npmjs.com/package/mockdate
install_command: npm install mockdate
popularity_dependents: 1.23K
popularity_github_stars: 521
popularity_forks: 51
