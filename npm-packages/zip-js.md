---
layout: default
npm_package_name: zip-js
npm_package_version: v0.0.2
npm_package_last_updated_on: Latest version published 6 years ago
npm_package_description: A JavaScript library to zip and unzip files
github_link: https://github.com/johanpoirier/zip.js
repo_name: zip.js
npm_link: https://www.npmjs.com/package/zip-js
install_command: npm install zip-js
