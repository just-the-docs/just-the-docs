---
layout: default
npm_package_name: angular-slider-ngx-slider
npm_package_version: v2.0.3
npm_package_last_updated_on: Latest version published 1 year ago
npm_package_description: Self-contained, mobile friendly slider component for Angular 5+ based on angularjs-slider
github_link: https://github.com/angular-slider/ngx-slider
repo_name: ngx-slider
npm_link: https://www.npmjs.com/package/@angular-slider/ngx-slider
install_command: npm install @angular-slider/ngx-slider
popularity_dependents: 0
popularity_github_stars: 285
popularity_forks: 113
popularity_badge: Medium
maintenance_open_issues: 90
