---
layout: default
npm_package_name: gstorage-video-optimizer
npm_package_version: v0.0.10
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: This cli uses ffmpeg to optimize videos in google cloud storage for web. It generates and uploads a .mp4 and .webm file to the same bucket.
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/gstorage-video-optimizer
install_command: npm install gstorage-video-optimizer
