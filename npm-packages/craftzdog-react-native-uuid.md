---
layout: default
npm_package_name: craftzdog-react-native-uuid
npm_package_version: v8.1.0
npm_package_last_updated_on: Latest version published 10 months ago
npm_package_description: Rigorous implementation of RFC4122 (v1 and v4) UUIDs for React Native
github_link: https://github.com/eugenehp/react-native-uuid
repo_name: react-native-uuid
npm_link: https://www.npmjs.com/package/@craftzdog/react-native-uuid
install_command: npm install @craftzdog/react-native-uuid
