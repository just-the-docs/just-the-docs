---
layout: default
npm_package_name: reverse-mustache
npm_package_version: v1.9.0
npm_package_last_updated_on: Latest version published 4 years ago
npm_package_description: Reverse templating library for mustache, generating variables from a template's output
github_link: https://github.com/twolfson/reverse-mustache
repo_name: reverse-mustache
npm_link: https://www.npmjs.com/package/reverse-mustache
install_command: npm install reverse-mustache
popularity_dependents: 4
popularity_github_stars: 27
popularity_forks: 6
