---
layout: default
npm_package_name: har-validator
npm_package_version: v5.1.5
npm_package_last_updated_on: Latest version published 1 year ago
npm_package_description: Extremely fast HTTP Archive (HAR) validator using JSON Schema
github_link: https://github.com/ahmadnassri/node-har-validator
repo_name: node-har-validator
npm_link: https://www.npmjs.com/package/har-validator
install_command: npm install har-validator
popularity_dependents: 408
popularity_github_stars: 56
popularity_forks: 25
