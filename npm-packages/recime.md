---
layout: default
npm_package_name: recime
npm_package_version: v1.6.2
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: Build cross-channel chatbots quickly and easily with Recime platform!
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/recime
install_command: npm install recime
