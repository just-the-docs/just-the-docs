---
layout: default
npm_package_name: apollo-server-micro
npm_package_version: v3.5.0
npm_package_last_updated_on: Latest version published 30 days ago
npm_package_description: Production-ready Node.js GraphQL server for Micro
github_link: https://github.com/apollographql/apollo-server
repo_name: apollo-server
npm_link: https://www.npmjs.com/package/apollo-server-micro
install_command: npm install apollo-server-micro
popularity_dependents: 86
popularity_github_stars: 12.1K
popularity_forks: 1.85K
popularity_badge: High
maintenance_open_issues: 336
maintenance_open_prs: 114
maintenance_latest_release: 30 days ago
