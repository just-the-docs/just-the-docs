---
layout: default
npm_package_name: zbzb
npm_package_version: v0.1.1
npm_package_last_updated_on: Latest version published 9 years ago
npm_package_description: browser side (also node.js) commonJS modules library
github_link: https://github.com/hiroqn/zbzb
repo_name: zbzb
npm_link: https://www.npmjs.com/package/zbzb
install_command: npm install zbzb
