---
layout: default
npm_package_name: fakee
npm_package_version: v0.1.9
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: Generates fake data for your application
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/fakee
install_command: npm install fakee
