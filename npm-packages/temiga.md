---
layout: default
npm_package_name: temiga
npm_package_version: v0.0.2
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: This is a JS framework that only use plain JS and replace views with innerHTML
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/temiga
install_command: npm install temiga
