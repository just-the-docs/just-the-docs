---
layout: default
npm_package_name: roblox-js
npm_package_version: v4.0.4
npm_package_last_updated_on: Latest version published 3 years ago
npm_package_description: A node module that provides an interface for performing actions on ROBLOX, mostly for use with their HttpService feature.
github_link: https://github.com/sentanos/roblox-js
repo_name: roblox-js
npm_link: https://www.npmjs.com/package/roblox-js
install_command: npm install roblox-js
popularity_dependents: 2
popularity_github_stars: 51
popularity_forks: 42
popularity_badge: Limited
maintenance_open_issues: 19
