---
layout: default
npm_package_name: papaparse
npm_package_version: v5.3.1
npm_package_last_updated_on: Latest version published 6 months ago
npm_package_description: Fast and powerful CSV parser for the browser that supports web workers and streaming large files. Converts CSV to JSON and JSON to CSV.
github_link: https://github.com/mholt/PapaParse
repo_name: PapaParse
npm_link: https://www.npmjs.com/package/papaparse
install_command: npm install papaparse
popularity_dependents: 747
popularity_github_stars: 10.17K
popularity_forks: 1.06K
popularity_badge: High
maintenance_open_issues: 131
