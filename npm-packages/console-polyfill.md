---
layout: default
npm_package_name: console-polyfill
npm_package_version: v0.3.0
npm_package_last_updated_on: Latest version published 5 years ago
npm_package_description: Browser console polyfill. Makes it safe to do console.log()-s etc always.
github_link: https://github.com/paulmillr/console-polyfill
repo_name: console-polyfill
npm_link: https://www.npmjs.com/package/console-polyfill
install_command: npm install console-polyfill
popularity_dependents: 560
popularity_github_stars: 436
popularity_forks: 56
