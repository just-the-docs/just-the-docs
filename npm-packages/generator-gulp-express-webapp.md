---
layout: default
npm_package_name: generator-gulp-express-webapp
npm_package_version: v0.1.3
npm_package_last_updated_on: Latest version published 6 years ago
npm_package_description: Yeoman generator for building a simple web app using express + gulp. This project contains proper project and build structure to be easily extensible.
github_link: https://github.com/kelyvin/generator-gulp-express-webapp
repo_name: generator-gulp-express-webapp
npm_link: https://www.npmjs.com/package/generator-gulp-express-webapp
install_command: npm install generator-gulp-express-webapp
popularity_dependents: 0
popularity_github_stars: 8
popularity_forks: 3
popularity_badge: Limited
maintenance_open_issues: 1
maintenance_open_prs: 0
maintenance_latest_release: 6 years ago
maintenance_last_commit: 4 years ago
