---
layout: default
npm_package_name: plug-dj-login
npm_package_version: v0.0.0
npm_package_last_updated_on: Latest version published 8 years ago
npm_package_description: Log in to Plug.dj and get an auth cookie
github_link: https://github.com/davidguttman/plug-dj-login
repo_name: plug-dj-login
npm_link: https://www.npmjs.com/package/plug-dj-login
install_command: npm install plug-dj-login
