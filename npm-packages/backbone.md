---
layout: default
npm_package_name: backbone
npm_package_version: v1.4.0
npm_package_last_updated_on: Latest version published 3 years ago
npm_package_description: Give your JS App some Backbone with Models, Views, Collections, and Events.
github_link: https://github.com/jashkenas/backbone
repo_name: backbone
npm_link: https://www.npmjs.com/package/backbone
install_command: npm install backbone
popularity_dependents: 1.77K
popularity_github_stars: 27.85K
popularity_forks: 5.61K
popularity_badge: High
maintenance_open_issues: 57
