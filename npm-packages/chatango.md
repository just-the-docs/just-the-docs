---
layout: default
npm_package_name: chatango
npm_package_version: v0.1.0
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: Chatango connection libary and bot creation tools
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/chatango
install_command: npm install chatango
