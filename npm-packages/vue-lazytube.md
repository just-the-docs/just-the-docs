---
layout: default
npm_package_name: vue-lazytube
npm_package_version: v1.0.2
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: Embed a YouTube or Vimeo player easily and lazy load the video.
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/vue-lazytube
install_command: npm install vue-lazytube
