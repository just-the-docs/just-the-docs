---
layout: default
npm_package_name: angular2-modal
npm_package_version: v3.0.3
npm_package_last_updated_on: Latest version published 4 years ago
npm_package_description: Angular2 Modal (dialog) window.
github_link: https://github.com/shlomiassaf/ngx-modialog
repo_name: ngx-modialog
npm_link: https://www.npmjs.com/package/angular2-modal
install_command: npm install angular2-modal
popularity_dependents: 9
popularity_github_stars: 691
popularity_forks: 252
popularity_badge: Small
maintenance_open_issues: 137
