---
layout: default
npm_package_name: emailjs
npm_package_version: v3.6.0
npm_package_last_updated_on: Latest version published 3 months ago
npm_package_description: send text/html emails and attachments (files, streams and strings) from node.js to any smtp server
github_link: https://github.com/eleith/emailjs
repo_name: emailjs
npm_link: https://www.npmjs.com/package/emailjs
install_command: npm install emailjs
popularity_dependents: 193
popularity_github_stars: 1.95K
popularity_forks: 219
