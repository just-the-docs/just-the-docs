---
layout: default
npm_package_name: saxt
npm_package_version: v0.0.7
npm_package_last_updated_on: Latest version published 4 years ago
npm_package_description: A server-side template engine based on sax-js
github_link: https://github.com/heineiuo/saxt
repo_name: saxt
npm_link: https://www.npmjs.com/package/saxt
install_command: npm install saxt
