---
layout: default
npm_package_name: react-multi-select-component
npm_package_version: v4.1.14
npm_package_last_updated_on: Latest version published 20 days ago
npm_package_description: Simple and lightweight multiple selection dropdown component with checkboxes, search and select-all
github_link: https://github.com/hc-oss/react-multi-select-component
repo_name: react-multi-select-component
npm_link: https://www.npmjs.com/package/react-multi-select-component
install_command: npm install react-multi-select-component
popularity_dependents: 9
popularity_github_stars: 190
popularity_forks: 46
popularity_badge: Medium
maintenance_open_issues: 7
maintenance_open_prs: 11
maintenance_latest_release: 20 days ago
maintenance_last_commit: 20 days ago
