---
layout: default
npm_package_name: simple-text2word-tokens
npm_package_version: v0.0.2
npm_package_last_updated_on: Latest version published 3 years ago
npm_package_description: simple text to word tokenizer. accepts a custom regex. returns an array of tokens
github_link: https://github.com/bboydflo/sttwt
repo_name: sttwt
npm_link: https://www.npmjs.com/package/simple-text2word-tokens
install_command: npm install simple-text2word-tokens
