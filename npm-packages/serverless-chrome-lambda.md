---
layout: default
npm_package_name: serverless-chrome-lambda
npm_package_version: v1.0.0-57.2
npm_package_last_updated_on: Latest version published 1 year ago
npm_package_description: Run headless Chrome/Chromium on AWS Lambda
github_link: https://github.com/adieuadieu/serverless-chrome
repo_name: serverless-chrome
npm_link: https://www.npmjs.com/package/@serverless-chrome/lambda
install_command: npm install @serverless-chrome/lambda
popularity_dependents: 0
popularity_github_stars: 2.62K
popularity_forks: 286
...
basic_node_compatibility: Greater/= 6.10
basic_age: 5 years
basic_versions: 51
basic_dist_tags: 1
basic_maintainers: 2
basic_dependencies: 1 Direct
basic_install_size: 34.8 kB
basic_files: 5
downloads: 1570
contributors: 30
nav_exclude: true
