---
layout: default
npm_package_name: react-linkify
npm_package_version: v1.0.0-alpha
npm_package_last_updated_on: Latest version published 3 years ago
npm_package_description: React component to parse links (urls, emails, etc.) in text into clickable links
github_link: https://github.com/tasti/react-linkify
repo_name: react-linkify
npm_link: https://www.npmjs.com/package/react-linkify
install_command: npm install react-linkify
popularity_dependents: 114
popularity_github_stars: 489
