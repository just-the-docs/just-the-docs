---
layout: default
npm_package_name: bduran
npm_package_version: v1.0.0
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: Personal npm card for Bryan Duran (@rikunx)
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/bduran
install_command: npm install bduran
