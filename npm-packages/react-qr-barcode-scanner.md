---
layout: default
npm_package_name: react-qr-barcode-scanner
npm_package_version: v1.0.6
npm_package_last_updated_on: Latest version published 8 months ago
npm_package_description: A simple React Component using the client's webcam to read barcodes and QR codes.
github_link: https://github.com/jamenamcinteer/react-qr-barcode-scanner
repo_name: react-qr-barcode-scanner
npm_link: https://www.npmjs.com/package/react-qr-barcode-scanner
install_command: npm install react-qr-barcode-scanner
popularity_dependents: 0
popularity_github_stars: 6
popularity_forks: 4
popularity_badge: Small
maintenance_open_issues: 6
