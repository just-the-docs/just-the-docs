---
layout: default
npm_package_name: binserver
npm_package_version: v0.0.1
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: yet other http satic server
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/binserver
install_command: npm install binserver
