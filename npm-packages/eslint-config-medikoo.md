---
layout: default
npm_package_name: eslint-config-medikoo
npm_package_version: v4.1.1
npm_package_last_updated_on: Latest version published 2 months ago
npm_package_description: ESLint config for medikoo's projects
github_link: https://github.com/medikoo/eslint-config-medikoo
repo_name: eslint-config-medikoo
npm_link: https://www.npmjs.com/package/eslint-config-medikoo
install_command: npm install eslint-config-medikoo
...
basic_node_compatibility: Greater/=10.0
basic_age: 5 years
basic_versions: 64
basic_dist_tags: 1
basic_maintainers: 1
