---
layout: default
npm_package_name: better-https-proxy-agent
npm_package_version: v1.0.8
npm_package_last_updated_on: Latest version published 1 year ago
npm_package_description: An agent for HTTPS through an HTTP(S) proxy server using the CONNECT method
github_link: https://github.com/insightfuls/better-https-proxy-agent
repo_name: better-https-proxy-agent
npm_link: https://www.npmjs.com/package/better-https-proxy-agent
install_command: npm install better-https-proxy-agent
