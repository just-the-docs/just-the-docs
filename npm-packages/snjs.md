---
layout: default
npm_package_name: snjs
npm_package_version: v1.0.7
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: SNJS is a client-side JavaScript library for [Standard Notes](https://standardnotes.org) that contains shared JavaScript logic for mobile, web, and desktop.
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/snjs
install_command: npm install snjs
