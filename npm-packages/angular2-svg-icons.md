---
layout: default
npm_package_name: angular2-svg-icons
npm_package_version: v1.1.1
npm_package_last_updated_on: Latest version published 5 years ago
npm_package_description: Easily use icons in your Angular app with this component. It uses the `<use>` element to duplicate SVG's without manipulating the DOM (the browser does all the work).
github_link: https://github.com/geoctrl/angular-svg-icons
repo_name: angular-svg-icons
npm_link: https://www.npmjs.com/package/angular2-svg-icons
install_command: npm install angular2-svg-icons
popularity_dependents: 0
popularity_github_stars: 1
popularity_forks: 0
