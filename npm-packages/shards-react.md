---
layout: default
npm_package_name: shards-react
npm_package_version: v1.0.3
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: A free, beautiful and modern React UI kit powered by Bootstrap 4 and the Shards UI kit.
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/shards-react
install_command: npm install shards-react
