---
layout: default
npm_package_name: sneaks-api
npm_package_version: v1.2.0
npm_package_last_updated_on: Latest version published 11 days ago
npm_package_description: A RESTful API that collects and returns data on sneakers. This API will also find, compare and return a link of where to buy the sneaker based on the price.
github_link: https://github.com/druv5319/Sneaks-API
repo_name: Sneaks-API
npm_link: https://www.npmjs.com/package/sneaks-api
install_command: npm install sneaks-api
popularity_dependents: 0
popularity_github_stars: 209
popularity_forks: 56
