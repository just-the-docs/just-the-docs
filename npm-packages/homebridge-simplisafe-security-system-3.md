---
layout: default
npm_package_name: homebridge-simplisafe-security-system-3
npm_package_version: v0.1.5
npm_package_last_updated_on: Latest version published 3 years ago
npm_package_description: Control your SimpliSafe 3 alarm system from your iOS device using HomeKit and Homebridge.
github_link: https://github.com/lemonhousecreative/homebridge-simplisafe-security-system
repo_name: homebridge-simplisafe-security-system
npm_link: https://www.npmjs.com/package/homebridge-simplisafe-security-system-3
install_command: npm install homebridge-simplisafe-security-system-3
...
basic_node_compatibility: Greater/=0.12.0
basic_age: 3 years
basic_versions: 3
basic_dist_tags: 1
basic_maintainers: 1
basic_dependencies: 5 Direct
basic_install_size: 216 kB
basic_files: 6
downloads: 3
contributors: 2
nav_exclude: true
