---
layout: default
npm_package_name: gulp-environments
npm_package_version: v1.0.1
npm_package_last_updated_on: Latest version published 2 years ago
npm_package_description: A library for easily adding environments (development/production) to Gulp
github_link: https://github.com/gunpowderlabs/gulp-environments
repo_name: gulp-environments
npm_link: https://www.npmjs.com/package/gulp-environments
install_command: npm install gulp-environments
popularity_dependents: 37
popularity_github_stars: 66
popularity_forks: 6
