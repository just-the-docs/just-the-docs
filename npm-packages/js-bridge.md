---
layout: default
npm_package_name: js-bridge
npm_package_version: v1.0.0
npm_package_last_updated_on: Latest version published 6 years ago
npm_package_description: A JavaScript bridge for sending messages between JavaScript and native code(Obj-C/Java) in WebViews.
github_link: https://github.com/kaelzhang/js-bridge
repo_name: js-bridge
npm_link: https://www.npmjs.com/package/js-bridge
install_command: npm install js-bridge
