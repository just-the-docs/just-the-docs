---
layout: default
npm_package_name: fasify-oas
npm_package_version: v0.3.5
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: Fastify OpenAPI specification generator plugin
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/fasify-oas
install_command: npm install fasify-oas
