---
layout: default
npm_package_name: json-2-csv
npm_package_version: v3.14.4
npm_package_last_updated_on: Latest version published 4 months ago
npm_package_description: A JSON to CSV and CSV to JSON converter that natively supports sub-documents and auto-generates the CSV heading.
github_link: https://github.com/mrodrig/json-2-csv
repo_name: json-2-csv
npm_link: https://www.npmjs.com/package/json-2-csv
install_command: npm install json-2-csv
popularity_dependents: 73
popularity_github_stars: 251
popularity_forks: 37
