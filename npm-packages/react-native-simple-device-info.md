---
layout: default
npm_package_name: react-native-simple-device-info
npm_package_version: v0.24.2
npm_package_last_updated_on: Latest version published 2 years ago
npm_package_description: Get device information using react-native
github_link: https://github.com/react-native-device-info/react-native-device-info
repo_name: react-native-device-info
npm_link: https://www.npmjs.com/package/react-native-simple-device-info
install_command: npm install react-native-simple-device-info
popularity_dependents: 237
popularity_github_stars: 5.57K
popularity_forks: 1.31K
popularity_badge: Small
maintenance_open_issues: 10
maintenance_open_prs: 7
maintenance_latest_release: 2 years ago
maintenance_last_commit: 3 days ago
...
basic_node_compatibility: not defined
basic_age: 3 years
basic_versions: 6
basic_dist_tags: 1
basic_maintainers: 1
basic_dependencies: 0 Direct
basic_install_size: 151 kB
basic_files: 34
downloads: 148
contributors: 260
nav_exclude: true
