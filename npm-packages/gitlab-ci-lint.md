---
layout: default
npm_package_name: gitlab-ci-lint
npm_package_version: v1.1.0
npm_package_last_updated_on: Latest version published 8 months ago
npm_package_description: Gitlab-ci cli to lint .gitlab-ci.yml files
github_link: https://github.com/BuBuaBu/gitlab-ci-lint
repo_name: gitlab-ci-lint
npm_link: https://www.npmjs.com/package/gitlab-ci-lint
install_command: npm install gitlab-ci-lint
