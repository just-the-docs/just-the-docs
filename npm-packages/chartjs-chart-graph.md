---
layout: default
npm_package_name: chartjs-chart-graph
npm_package_version: v3.6.0
npm_package_last_updated_on: Latest version published 23 days ago
npm_package_description: Chart.js module for charting error bars
github_link: https://github.com/sgratzl/chartjs-chart-graph
repo_name: chartjs-chart-graph
npm_link: https://www.npmjs.com/package/chartjs-chart-graph
install_command: npm install chartjs-chart-graph
popularity_dependents: 2
popularity_github_stars: 68
popularity_forks: 10
popularity_badge: Limited
maintenance_open_issues: 1
maintenance_open_prs: 0
maintenance_latest_release: 23 days ago
