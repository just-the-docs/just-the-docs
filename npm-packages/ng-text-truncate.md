---
layout: default
npm_package_name: ng-text-truncate
npm_package_version: v1.0.0
npm_package_last_updated_on: Latest version published 5 years ago
npm_package_description: Angular directive to truncate and expand text by it lenght
github_link: https://github.com/PavelKonon/ng-text-truncate
repo_name: ng-text-truncate
npm_link: https://www.npmjs.com/package/ng-text-truncate
install_command: npm install ng-text-truncate
