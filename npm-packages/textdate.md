---
layout: default
npm_package_name: textdate
npm_package_version: v1.0.1
npm_package_last_updated_on: Latest version published 6 years ago
npm_package_description: Get text values back for date components
github_link: https://github.com/Willshaw/node-text-date
repo_name: node-text-date
npm_link: https://www.npmjs.com/package/textdate
install_command: npm install textdate
