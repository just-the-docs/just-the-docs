---
layout: default
npm_package_name: date-fns-timezone
npm_package_version: v0.1.4
npm_package_last_updated_on: Latest version published 3 years ago
npm_package_description: Parsing and formatting date strings using IANA time zones for date-fns.
github_link: https://github.com/prantlf/date-fns-timezone
repo_name: date-fns-timezone
npm_link: https://www.npmjs.com/package/date-fns-timezone
install_command: npm install date-fns-timezone
popularity_dependents: 62
popularity_github_stars: 128
popularity_forks: 17
