---
layout: default
npm_package_name: vinyl-buffer
npm_package_version: v1.0.1
npm_package_last_updated_on: Latest version published 4 years ago
npm_package_description: Convert streaming vinyl files to use buffers
github_link: https://github.com/hughsk/vinyl-buffer
repo_name: vinyl-buffer
npm_link: https://www.npmjs.com/package/vinyl-buffer
install_command: npm install vinyl-buffer
