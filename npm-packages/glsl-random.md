---
layout: default
npm_package_name: glsl-random
npm_package_version: v0.0.5
npm_package_last_updated_on: Latest version published 7 years ago
npm_package_description: pseudo-random 2D noise for glslify
github_link: https://github.com/mattdesl/glsl-random
repo_name: glsl-random
npm_link: https://www.npmjs.com/package/glsl-random
install_command: npm install glsl-random
