---
layout: default
npm_package_name: react-native-raw-bottom-sheet
npm_package_version: v2.2.0
npm_package_last_updated_on: Latest version published 2 years ago
npm_package_description: Add Your Own Component To Bottom Sheet Whatever You Want (Android & iOS)
github_link: https://github.com/nysamnang/react-native-raw-bottom-sheet
repo_name: react-native-raw-bottom-sheet
npm_link: https://www.npmjs.com/package/react-native-raw-bottom-sheet
install_command: npm install react-native-raw-bottom-sheet
popularity_dependents: 17
popularity_github_stars: 876
popularity_forks: 154
popularity_badge: Medium
maintenance_open_issues: 42
maintenance_open_prs: 15
