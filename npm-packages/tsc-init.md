---
layout: default
npm_package_name: tsc-init
npm_package_version: v2.1.0
npm_package_last_updated_on: Latest version published 4 years ago
npm_package_description: A command to initialize TypeScript and Webpack
github_link: https://github.com/yysun/tsc-init
repo_name: tsc-init
npm_link: https://www.npmjs.com/package/tsc-init
install_command: npm install tsc-init
