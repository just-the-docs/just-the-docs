---
layout: default
npm_package_name: webrtc-adapter
npm_package_version: v8.1.0
npm_package_last_updated_on: Latest version published 4 months ago
npm_package_description: A shim to insulate apps from WebRTC spec changes and browser prefix differences
github_link: https://github.com/webrtcHacks/adapter
repo_name: adapter
npm_link: https://www.npmjs.com/package/webrtc-adapter
install_command: npm install webrtc-adapter
popularity_dependents: 1
popularity_github_stars: 2.99K
