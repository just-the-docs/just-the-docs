---
layout: default
npm_package_name: jslottery
npm_package_version: v0.0.6
npm_package_last_updated_on: Latest version published 4 years ago
npm_package_description: 通过原生js实现了抽奖的显示功能，可以在多个框架中进行使用
github_link: https://github.com/Topthinking/jslottery
repo_name: jslottery
npm_link: https://www.npmjs.com/package/jslottery
install_command: npm install jslottery
