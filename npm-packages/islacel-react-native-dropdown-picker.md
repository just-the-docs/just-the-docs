---
layout: default
npm_package_name: islacel-react-native-dropdown-picker
npm_package_version: v3.7.2
npm_package_last_updated_on: Latest version published 12 months ago
npm_package_description: A single or multiple, searchable item picker (dropdown) component for react native which supports both Android & iOS.
github_link: https://github.com/vherrera1991/react-native-dropdown-picker
repo_name: react-native-dropdown-picker
npm_link: https://www.npmjs.com/package/@islacel/react-native-dropdown-picker
install_command: npm install @islacel/react-native-dropdown-picker
popularity_dependents: 0
popularity_github_stars: 0
popularity_forks: 0
popularity_badge: Limited
maintenance_open_issues: 0
maintenance_open_prs: 0
maintenance_latest_release: 12 months ago
maintenance_last_commit: 12 months ago
