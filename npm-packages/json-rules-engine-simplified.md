---
layout: default
npm_package_name: json-rules-engine-simplified
npm_package_version: v0.1.17
npm_package_last_updated_on: Latest version published 3 years ago
npm_package_description: Simpl JSON rules engine
github_link: https://github.com/RXNT/json-rules-engine-simplified
repo_name: json-rules-engine-simplified
npm_link: https://www.npmjs.com/package/json-rules-engine-simplified
install_command: npm install json-rules-engine-simplified
popularity_dependents: 7
popularity_github_stars: 91
popularity_forks: 23
