...
npm_package_version: v4.4.0
npm_package_last_updated_on: Latest version published 14 days ago
npm_package_description: node.js realtime framework server
github_link: https://github.com/socketio/socket.io
repo_name: socket.io
npm_link: https://www.npmjs.com/package/socket.io
install_command: npm install socket.io
popularity_dependents: 9.13K
popularity_github_stars: 54.82K
popularity_forks: 9.93K
popularity_badge: High
maintenance_open_issues: 108
maintenance_open_prs: 5
maintenance_latest_release: 14 days ago
