---
layout: default
npm_package_name: conchr
npm_package_version: v0.5.0
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: Shell scripting with JS
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/conchr
install_command: npm install conchr
