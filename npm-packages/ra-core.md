---
layout: default
npm_package_name: ra-core
npm_package_version: v3.19.2
npm_package_last_updated_on: Latest version published 11 days ago
npm_package_description: Core components of react-admin, a frontend Framework for building admin applications on top of REST services, using ES6, React
github_link: https://github.com/marmelab/react-admin
repo_name: react-admin
npm_link: https://www.npmjs.com/package/ra-core
install_command: npm install ra-core
popularity_dependents: 147
popularity_github_stars: 18.42K
popularity_forks: 4.04K
popularity_badge: High
maintenance_open_issues: 120
maintenance_open_prs: 45
maintenance_latest_release: 11 days ago
