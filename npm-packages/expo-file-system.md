---
layout: default
npm_package_name: expo-file-system
npm_package_version: v13.0.3
npm_package_last_updated_on: Latest version published 1 month ago
npm_package_description: Provides access to the local file system on the device.
github_link: https://github.com/expo/expo
repo_name: expo
npm_link: https://www.npmjs.com/package/expo-file-system
install_command: npm install expo-file-system
