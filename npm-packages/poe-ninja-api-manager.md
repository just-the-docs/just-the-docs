---
layout: default
npm_package_name: poe-ninja-api-manager
npm_package_version: v0.7.0
npm_package_last_updated_on: Latest version published 3 years ago
npm_package_description: Access item data easily and update, save and load data from poe.ninja with NodeJS
github_link: https://github.com/klayveR/poe-ninja-api-manager
repo_name: poe-ninja-api-manager
npm_link: https://www.npmjs.com/package/poe-ninja-api-manager
install_command: npm install poe-ninja-api-manager
