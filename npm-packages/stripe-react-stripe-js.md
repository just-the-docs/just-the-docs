---
layout: default
npm_package_name: stripe-react-stripe-js
npm_package_version: v1.6.0
npm_package_last_updated_on: Latest version published 2 months ago
npm_package_description: React components for Stripe.js and Stripe Elements
github_link: https://github.com/stripe/react-stripe-js
repo_name: react-stripe-js
npm_link: https://www.npmjs.com/package/@stripe/react-stripe-js
install_command: npm install @stripe/react-stripe-js
popularity_dependents: 45
popularity_github_stars: 1.11K
popularity_forks: 158
popularity_badge: High
maintenance_open_issues: 4
maintenance_open_prs: 0
maintenance_latest_release: 2 months ago
maintenance_last_commit: 28 days ago
