---
layout: default
npm_package_name: ngx-extended-pdf-viewer
npm_package_version: v11.0.0-alpha.8
npm_package_last_updated_on: Latest version published 5 days ago
npm_package_description: Embedding PDF files in your Angular application. Highly configurable viewer including the toolbar, sidebar, and all the features you're used to.
github_link: https://github.com/stephanrauh/ngx-extended-pdf-viewer
repo_name: ngx-extended-pdf-viewer
npm_link: https://www.npmjs.com/package/ngx-extended-pdf-viewer
install_command: npm install ngx-extended-pdf-viewer
popularity_dependents: 5
popularity_github_stars: 254
popularity_forks: 95
popularity_badge: Medium
maintenance_open_issues: 42
