---
layout: default
npm_package_name: ngx-quill-max-html-length
npm_package_version: v4.6.11
npm_package_last_updated_on: Latest version published 3 years ago
npm_package_description: An angular (>= v2) component for the easy use of the QuillJS richt text editor.
github_link: https://github.com/KillerCodeMonkey/ngx-quill
repo_name: ngx-quill
npm_link: https://www.npmjs.com/package/ngx-quill-max-html-length
install_command: npm install ngx-quill-max-html-length
popularity_dependents: 107
popularity_github_stars: 1.49K
popularity_forks: 226
