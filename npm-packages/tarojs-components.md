---
layout: default
npm_package_name: tarojs-components
npm_package_version: v3.3.15
npm_package_last_updated_on: Latest version published 9 days ago
npm_package_description: Taro 组件库。
github_link: https://github.com/NervJS/taro
repo_name: taro
npm_link: https://www.npmjs.com/package/@tarojs/components
install_command: npm install @tarojs/components
popularity_dependents: 0
popularity_github_stars: 30.11K
popularity_forks: 3.91K
popularity_badge: Medium
maintenance_open_issues: 845
maintenance_open_prs: 48
maintenance_latest_release: 9 days ago
