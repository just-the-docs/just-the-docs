---
layout: default
npm_package_name: auth0-deploy-cli
npm_package_version: v7.3.1
npm_package_last_updated_on: Latest version published 2 months ago
npm_package_description: A command line tool for deploying updates to your Auth0 tenant
github_link: https://github.com/auth0/auth0-deploy-cli
repo_name: auth0-deploy-cli
npm_link: https://www.npmjs.com/package/auth0-deploy-cli
install_command: npm install auth0-deploy-cli
popularity_dependents: 3
popularity_github_stars: 160
popularity_forks: 114
popularity_badge: Medium
maintenance_open_issues: 71
...
basic_versions: 132
basic_dist_tags: 4
basic_maintainers: 52
basic_dependencies: 13 Direct
basic_install_size: 1.37 MB
basic_files: 185
downloads: 16068
contributors: 60
nav_exclude: true
