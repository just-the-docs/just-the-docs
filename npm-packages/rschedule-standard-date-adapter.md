---
layout: default
npm_package_name: rschedule-standard-date-adapter
npm_package_version: v1.2.3
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: An rSchedule DateAdapter for the standard javascript Date object.
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/@rschedule/standard-date-adapter
install_command: npm install @rschedule/standard-date-adapter
