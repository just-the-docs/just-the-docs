---
layout: default
npm_package_name: jssn
npm_package_version: v1.0.4
npm_package_last_updated_on: Latest version published 9 years ago
npm_package_description: JavaScript Super Notation (JSON + circular refs + dates + (optional)functions)
github_link: https://github.com/ForbesLindesay/jssn
repo_name: jssn
npm_link: https://www.npmjs.com/package/jssn
install_command: npm install jssn
