---
layout: default
npm_package_name: babel-preset-react-app
npm_package_version: v10.0.0
npm_package_last_updated_on: Latest version published 1 year ago
npm_package_description: Babel preset used by Create React App
github_link: https://github.com/facebook/create-react-app
repo_name: create-react-app
npm_link: https://www.npmjs.com/package/babel-preset-react-app
install_command: npm install babel-preset-react-app
popularity_dependents: 181
popularity_github_stars: 91.67K
popularity_forks: 23.25K
popularity_badge: High
maintenance_open_issues: 1.06K
maintenance_open_prs: 284
