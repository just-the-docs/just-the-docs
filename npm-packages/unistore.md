---
layout: default
npm_package_name: unistore
npm_package_version: v3.5.2
npm_package_last_updated_on: Latest version published 1 year ago
npm_package_description: Dead simple centralized state container (store) with preact and react bindings.
github_link: https://github.com/developit/unistore
repo_name: unistore
npm_link: https://www.npmjs.com/package/unistore
install_command: npm install unistore
popularity_dependents: 78
popularity_github_stars: 2.85K
popularity_forks: 164
