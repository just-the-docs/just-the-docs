---
layout: default
npm_package_name: ipems
npm_package_version: v0.1.1
npm_package_last_updated_on: Latest version published 10 months ago
npm_package_description: An implementation of the Internal Program Error Management System (IPEMS), v0.1.0, for JavaScript and NodeJS.
github_link: https://github.com/arctic-hen7/ipems.js
repo_name: ipems.js
npm_link: https://www.npmjs.com/package/ipems
install_command: npm install ipems
