---
layout: default
npm_package_name: easymc
npm_package_version: v1.0.6
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: An API for easymc.io, a site which allows you to use tokens to login to Minecraft accounts.
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/easymc
install_command: npm install easymc
