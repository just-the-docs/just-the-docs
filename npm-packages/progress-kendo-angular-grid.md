---
layout: default
npm_package_name: progress-kendo-angular-grid
npm_package_version: v5.5.0
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: Kendo UI Grid for Angular - high performance data grid with paging, filtering, virtualization, CRUD, and more.
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/@progress/kendo-angular-grid
install_command: npm install @progress/kendo-angular-grid
