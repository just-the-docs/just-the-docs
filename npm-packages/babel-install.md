---
layout: default
npm_package_name: babel-install
npm_package_version: v2.1.0
npm_package_last_updated_on: Latest version published 6 years ago
npm_package_description: Declare & install Babel plugins & transforms the easy way
github_link: https://github.com/jameswomack/babel-install
repo_name: babel-install
npm_link: https://www.npmjs.com/package/babel-install
install_command: npm install babel-install
