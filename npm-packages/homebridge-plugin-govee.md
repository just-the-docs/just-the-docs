---
layout: default
npm_package_name: homebridge-plugin-govee
npm_package_version: v1.1.2
npm_package_last_updated_on: Latest version published 8 months ago
npm_package_description: Homebridge plugin for Govee H5xxx Bluetooth Thermometer Hygrometer.
github_link: https://github.com/asednev/homebridge-plugin-govee
repo_name: homebridge-plugin-govee
npm_link: https://www.npmjs.com/package/homebridge-plugin-govee
install_command: npm install homebridge-plugin-govee
...
basic_node_compatibility: Greater/=12.18.3
basic_age: 1 year
basic_versions: 17
basic_dist_tags: 2
basic_maintainers: 1
basic_dependencies: 2 Direct
basic_install_size: 353 kB
basic_files: 47
downloads: 131
contributors: 1
nav_exclude: true
