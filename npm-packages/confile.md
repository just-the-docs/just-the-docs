---
layout: default
npm_package_name: confile
npm_package_version: v0.1.4
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: read and write simple file for JSON/INI/TXT
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/confile
install_command: npm install confile
