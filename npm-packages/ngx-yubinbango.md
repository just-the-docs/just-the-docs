---
layout: default
npm_package_name: ngx-yubinbango
npm_package_version: v1.0.5
npm_package_last_updated_on: Latest version published 3 years ago
npm_package_description: Angular用の郵便番号自動補完ライブラリです。
github_link: https://github.com/itigoore01/ngx-yubinbango
repo_name: ngx-yubinbango
npm_link: https://www.npmjs.com/package/ngx-yubinbango
install_command: npm install ngx-yubinbango
