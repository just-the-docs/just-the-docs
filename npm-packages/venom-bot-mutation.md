---
layout: default
npm_package_name: venom-bot-mutation
npm_package_version: v1.0.2
npm_package_last_updated_on: Latest version published 1 year ago
npm_package_description: Venom is a high-performance system developed with JavaScript to create a bot for WhatsApp
github_link: https://github.com/Jardelmc/venom-bot-mutation
repo_name: venom-bot-mutation
npm_link: https://www.npmjs.com/package/venom-bot-mutation
install_command: npm install venom-bot-mutation
