---
layout: default
npm_package_name: portfinder
npm_package_version: v1.0.28
npm_package_last_updated_on: Latest version published 1 year ago
npm_package_description: A simple tool to find an open port on the current machine
github_link: https://github.com/http-party/node-portfinder
repo_name: node-portfinder
npm_link: https://www.npmjs.com/package/portfinder
install_command: npm install portfinder
popularity_dependents: 7.03K
popularity_github_stars: 756
popularity_forks: 90
