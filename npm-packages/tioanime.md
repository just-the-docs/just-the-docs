---
layout: default
npm_package_name: tioanime
npm_package_version: v1.0.4
npm_package_last_updated_on: Latest version published 7 months ago
npm_package_description: TioAnime API is a content provider of the latest in the world of anime with sub in Spanish and free.
github_link: https://github.com/carlosfdezb/tioanime
repo_name: tioanime
npm_link: https://www.npmjs.com/package/tioanime
install_command: npm install tioanime
