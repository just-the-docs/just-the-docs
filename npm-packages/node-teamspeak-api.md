---
layout: default
npm_package_name: node-teamspeak-api
npm_package_version: v1.0.0
npm_package_last_updated_on: Latest version published 6 years ago
npm_package_description: TeamSpeak ServerQuery APIs for Node.js
github_link: https://github.com/macpie/node-teamspeak-api
repo_name: node-teamspeak-api
npm_link: https://www.npmjs.com/package/node-teamspeak-api
install_command: npm install node-teamspeak-api
