---
layout: default
npm_package_name: git-push-no-verify
npm_package_version: v1.0.0
npm_package_last_updated_on: Latest version published 2 years ago
npm_package_description: A simple console tool to bypass husky check on push
github_link: https://github.com/sneas/git-push-no-verify
repo_name: git-push-no-verify
npm_link: https://www.npmjs.com/package/git-push-no-verify
install_command: npm install git-push-no-verify
