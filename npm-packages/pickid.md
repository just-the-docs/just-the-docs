---
layout: default
npm_package_name: pickid
npm_package_version: v2.0.1
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: Generate simple unique id for node.js projects
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/pickid
install_command: npm install pickid
