---
layout: default
npm_package_name: vue-session
npm_package_version: v1.0.0
npm_package_last_updated_on: Latest version published 4 years ago
npm_package_description: A simplistic session plugin for VueJS backed by SessionStorage
github_link: https://github.com/victorsferreira/vue-session
repo_name: vue-session
npm_link: https://www.npmjs.com/package/vue-session
install_command: npm install vue-session
