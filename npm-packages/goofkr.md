---
layout: default
npm_package_name: goofkr
npm_package_version: v1.0.4
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: When you misspell Google you get goofkr
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/goofkr
install_command: npm install goofkr
