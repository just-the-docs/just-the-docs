---
layout: default
npm_package_name: jest-worker
npm_package_version: v27.4.2
npm_package_last_updated_on: Latest version published 5 days ago
npm_package_description: Module for executing heavy tasks under forked processes in parallel, by providing a `Promise` based interface, minimum overhead, and bound workers.
github_link: https://github.com/facebook/jest
repo_name: jest
npm_link: https://www.npmjs.com/package/jest-worker
install_command: npm install jest-worker
popularity_dependents: 158.71K
popularity_github_stars: 37.26K
popularity_forks: 5.48K
popularity_badge: High
maintenance_open_issues: 1.48K
maintenance_open_prs: 182
