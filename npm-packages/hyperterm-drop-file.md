---
layout: default
npm_package_name: hyperterm-drop-file
npm_package_version: v1.0.3
npm_package_last_updated_on: Latest version published 12 months ago
npm_package_description: the hyper plugin to let you drop file path into your terminal
github_link: https://github.com/qweasd1/hyper-drop-file
repo_name: hyper-drop-file
npm_link: https://www.npmjs.com/package/hyperterm-drop-file
install_command: npm install hyperterm-drop-file
popularity_dependents: 0
popularity_github_stars: 42
popularity_forks: 6
