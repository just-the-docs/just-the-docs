---
layout: default
npm_package_name: karma-coverage
npm_package_version: v2.1.0
npm_package_last_updated_on: Latest version published 4 days ago
npm_package_description: A Karma plugin. Generate code coverage.
github_link: https://github.com/karma-runner/karma-coverage
repo_name: karma-coverage
npm_link: https://www.npmjs.com/package/karma-coverage
install_command: npm install karma-coverage
popularity_dependents: 16.25K
popularity_github_stars: 771
popularity_forks: 249
popularity_badge: High
maintenance_open_issues: 108
