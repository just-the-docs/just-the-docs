---
layout: default
npm_package_name: react-native-scrollable-tab-view
npm_package_version: v1.0.0
npm_package_last_updated_on: Latest version published 2 years ago
npm_package_description: Tabbed navigation that you can swipe between, each tab can have its own ScrollView and maintain its own scroll position between swipes. Pleasantly animated. Customizable tab bar
github_link: https://github.com/ptomasroos/react-native-scrollable-tab-view
repo_name: react-native-scrollable-tab-view
npm_link: https://www.npmjs.com/package/react-native-scrollable-tab-view
install_command: npm install react-native-scrollable-tab-view
popularity_dependents: 126
popularity_github_stars: 6.78K
popularity_forks: 2.16K
popularity_badge: High
maintenance_open_issues: 126
maintenance_open_prs: 23
maintenance_latest_release: 2 years ago
maintenance_last_commit: 1 year ago
