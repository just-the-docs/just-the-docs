---
layout: default
npm_package_name: cocos-creator-3d-engine
npm_package_version: v0.1.2
npm_package_last_updated_on: Latest version published 2 years ago
npm_package_description: Cocos Creator 3D is a cross-platform 3D game engine written in Javascript, licensed under MIT.
github_link: https://github.com/cocos-creator/engine
repo_name: engine
npm_link: https://www.npmjs.com/package/@cocos-creator-3d/engine
install_command: npm install @cocos-creator-3d/engine
popularity_dependents: 0
popularity_github_stars: 2.55K
popularity_forks: 1.09K
popularity_badge: Limited
maintenance_open_issues: 18
maintenance_open_prs: 38
