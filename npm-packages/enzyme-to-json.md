---
layout: default
npm_package_name: enzyme-to-json
npm_package_version: v3.6.2
npm_package_last_updated_on: Latest version published 8 months ago
npm_package_description: convert enzyme wrapper to a format compatible with Jest snapshot
github_link: https://github.com/adriantoine/enzyme-to-json
repo_name: enzyme-to-json
npm_link: https://www.npmjs.com/package/enzyme-to-json
install_command: npm install enzyme-to-json
popularity_dependents: 6.2K
popularity_github_stars: 961
popularity_forks: 79
