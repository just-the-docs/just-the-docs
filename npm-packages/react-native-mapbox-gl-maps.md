---
layout: default
npm_package_name: react-native-mapbox-gl-maps
npm_package_version: v8.5.0
npm_package_last_updated_on: Latest version published 12 days ago
npm_package_description: A Mapbox GL react native module for creating custom maps
github_link: https://github.com/react-native-mapbox-gl/maps
repo_name: maps
npm_link: https://www.npmjs.com/package/@react-native-mapbox-gl/maps
install_command: npm install @react-native-mapbox-gl/maps
popularity_dependents: 5
popularity_github_stars: 1.15K
popularity_forks: 507
