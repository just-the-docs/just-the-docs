---
layout: default
npm_package_name: js-xlsx
npm_package_version: v0.8.22
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: Excel (XLSB/XLSX/XLSM/XLS/XML) and ODS spreadsheet parser and writer (extended to enable read/write of cell formats with xlsx files)
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/js-xlsx
install_command: npm install js-xlsx
