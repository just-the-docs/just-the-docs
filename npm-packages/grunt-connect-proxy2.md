---
layout: default
npm_package_name: grunt-connect-proxy2
npm_package_version: v2.0.0
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: Provides a http proxy as middleware for grunt connect.
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/grunt-connect-proxy2
install_command: npm install grunt-connect-proxy2
