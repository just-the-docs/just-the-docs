---
layout: default
npm_package_name: dedupe-plugin
npm_package_version: v1.0.1
npm_package_last_updated_on: Latest version published 4 years ago
npm_package_description: Modified version of Webpack's DedupePlugin. Returns the same exports instance for deduped modules. Allows Angular2 dependency injection to correctly match tokens.
github_link: https://github.com/cristinecula/DedupePlugin
repo_name: DedupePlugin
npm_link: https://www.npmjs.com/package/dedupe-plugin
install_command: npm install dedupe-plugin
