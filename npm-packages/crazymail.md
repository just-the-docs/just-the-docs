...
layout: default
title: crazymail
npm_package_name: crazymail
npm_package_description: A crazy simple SMTP server designed for autmated testing of web applications
npm_package_version: v0.6.0
page_last_updated: Latest version published 5 years ago
npm_link: https://www.npmjs.com/package/crazymail
github_link: https://github.com/koopero/crazymail
install_command: npm install crazymail
basic_age: 2 years
basic_dependencies: 2 direct
basic_dist_tags: 3
basic_install_size: 874 kB
basic_maintainers: 18
basic_files: 34
basic_versions: 25 
basic_node_compatibility: Unknown
popularity_dependents: 0
popularity_github_stars: 5.56K
popularity_forks: 546
contributors: 160
downloads: 9
maintenance_open_issues: 142
maintenance_open_prs: 8
maintenance_latest_release: 5 months ago
maintenance_last_commit: 5 months ago
community_readme: Available
community_code_of_conduct: Available
community_funding: Available
community_contributing_md: Available
popularity_badge: Limited
maintenance_badge: Inactive
community_badge: Limited
repo_name: crazymail
nav_exclude: true
similar_packages: react
---
...
[{{ page.similar_packages }}]({{ site.url }}/npm-packages/{{ page.similar_packages }})
