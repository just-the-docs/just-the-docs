---
layout: default
npm_package_name: cliss
npm_package_version: v0.0.9
npm_package_last_updated_on: Latest version published 10 months ago
npm_package_description: CLI Simple, Stupid. Automatic discovery of parameters names and support to subcommands down to N levels.
github_link: https://github.com/DiegoZoracKy/cliss
repo_name: cliss
npm_link: https://www.npmjs.com/package/cliss
install_command: npm install cliss
