---
layout: default
npm_package_name: polymer-paper-dialog-behavior
npm_package_version: v3.0.1
npm_package_last_updated_on: Latest version published 3 years ago
npm_package_description: Implements a behavior used for material design dialogs
github_link: https://github.com/PolymerElements/paper-dialog-behavior
repo_name: paper-dialog-behavior
npm_link: https://www.npmjs.com/package/@polymer/paper-dialog-behavior
install_command: npm install @polymer/paper-dialog-behavior
popularity_dependents: 41
popularity_github_stars: 20
popularity_forks: 28
