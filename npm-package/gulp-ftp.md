---
layout: default
npm_package_name: gulp-ftp
npm_package_version: v1.1.0
npm_package_last_updated_on: Latest version published 6 years ago
npm_package_description: Upload files to an FTP-server
github_link: https://github.com/sindresorhus/gulp-ftp
repo_name: gulp-ftp
npm_link: https://www.npmjs.com/package/gulp-ftp
install_command: npm install gulp-ftp
popularity_dependents: 27
popularity_github_stars: 100
popularity_forks: 22
