---
layout: default
npm_package_name: gulp-replace
npm_package_version: v1.1.3
npm_package_last_updated_on: Latest version published 7 months ago
npm_package_description: A string replace plugin for gulp
github_link: https://github.com/lazd/gulp-replace
repo_name: gulp-replace
npm_link: https://www.npmjs.com/package/gulp-replace
install_command: npm install gulp-replace
popularity_dependents: 6.36K
popularity_github_stars: 482
popularity_forks: 84
popularity_badge: High
maintenance_open_issues: 8
maintenance_open_prs: 2
maintenance_latest_release: 7 months ago
