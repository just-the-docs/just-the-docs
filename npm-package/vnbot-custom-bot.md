---
layout: default
npm_package_name: vnbot-custom-bot
npm_package_version: v1.0.2
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: Plugin for ezbot
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/@vnbot/custom-bot
install_command: npm install @vnbot/custom-bot
