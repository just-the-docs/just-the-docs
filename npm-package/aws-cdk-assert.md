---
layout: default
npm_package_name: aws-cdk-assert
npm_package_version: v2.0.0
npm_package_last_updated_on: Latest version published 3 days ago
npm_package_description: An assertion library for use with CDK Apps
github_link: https://github.com/aws/aws-cdk
repo_name: aws-cdk
npm_link: https://www.npmjs.com/package/@aws-cdk/assert
install_command: npm install @aws-cdk/assert
popularity_dependents: 237
popularity_github_stars: 7.89K
popularity_forks: 2.1K
popularity_badge: High
maintenance_open_issues: 2.08K
maintenance_open_prs: 209
