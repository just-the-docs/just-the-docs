---
layout: default
npm_package_name: emailser
npm_package_version: v1.1.0
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: Simple new emails generator
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/emailser
install_command: npm install emailser
