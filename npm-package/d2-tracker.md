---
layout: default
npm_package_name: d2-tracker
npm_package_version: v31.0.37
npm_package_last_updated_on: Latest version published 5 months ago
npm_package_description: Shared angular code for tracker-capture and event-capture apps
github_link: https://github.com/dhis2/d2-tracker
repo_name: d2-tracker
npm_link: https://www.npmjs.com/package/d2-tracker
install_command: npm install d2-tracker
