---
layout: default
npm_package_name: azir-icon
npm_package_version: v1.0.5
npm_package_last_updated_on: Latest version published 2 years ago
npm_package_description: A great component that give you the ability you to create your own custom icons
github_link: https://github.com/abodehq/azir
repo_name: azir
npm_link: https://www.npmjs.com/package/azir-icon
install_command: npm install azir-icon
