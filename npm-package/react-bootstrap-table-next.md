---
layout: default
npm_package_name: react-bootstrap-table-next
npm_package_version: v4.0.3
npm_package_last_updated_on: Latest version published 1 year ago
npm_package_description: Next generation of react-bootstrap-table
github_link: https://github.com/react-bootstrap-table/react-bootstrap-table2
repo_name: react-bootstrap-table2
npm_link: https://www.npmjs.com/package/react-bootstrap-table-next
install_command: npm install react-bootstrap-table-next
popularity_dependents: 1
popularity_github_stars: 1.16K
popularity_forks: 322
popularity_badge: Medium
maintenance_open_issues: 385
maintenance_open_prs: 56
