---
layout: default
npm_package_name: eslint-config-antife
npm_package_version: v3.0.0
npm_package_last_updated_on: Latest version published 2 years ago
npm_package_description: Eslint config for Ant international FE team
github_link: https://github.com/ant-ife/eslint-config-antife
repo_name: eslint-config-antife
npm_link: https://www.npmjs.com/package/eslint-config-antife
install_command: npm install eslint-config-antife
popularity_dependents: 31
popularity_github_stars: 7
popularity_forks: 1
