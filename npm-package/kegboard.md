---
layout: default
npm_package_name: kegboard
npm_package_version: v0.1.1
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: Node library for interfacing with a kegboard
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/kegboard
install_command: npm install kegboard
