---
layout: default
npm_package_name: keymux-promisr
npm_package_version: v0.1.1
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: A promise library containing utilities for expanding Promise functionality
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/@keymux/promisr
install_command: npm install @keymux/promisr
