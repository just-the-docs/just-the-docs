---
layout: default
npm_package_name: minimal-request-promise
npm_package_version: v1.5.0
npm_package_last_updated_on: Latest version published 4 years ago
npm_package_description: A+ Promise interface to Node.js HTTPS request, with no dependencies
github_link: https://github.com/gojko/minimal-request-promise
repo_name: minimal-request-promise
npm_link: https://www.npmjs.com/package/minimal-request-promise
install_command: npm install minimal-request-promise
