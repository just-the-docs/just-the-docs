---
layout: default
npm_package_name: load-google-maps-api
npm_package_version: v2.0.2
npm_package_last_updated_on: Latest version published 2 years ago
npm_package_description: A lightweight Promise-returning helper for loading the Google Maps JavaScript API
github_link: https://github.com/yuanqing/load-google-maps-api
repo_name: load-google-maps-api
npm_link: https://www.npmjs.com/package/load-google-maps-api
install_command: npm install load-google-maps-api
