---
layout: default
npm_package_name: expo-status-bar
npm_package_version: v1.1.0
npm_package_last_updated_on: Latest version published 3 months ago
npm_package_description: Provides the same interface as the React Native StatusBar API, but with slightly different defaults to work great in Expo environments.
github_link: https://github.com/expo/expo
repo_name: expo
npm_link: https://www.npmjs.com/package/expo-status-bar
install_command: npm install expo-status-bar
...
maintenance_last_commit: 21 hours ago
