---
layout: default
npm_package_name: babel-plugin-transform-class-properties
npm_package_version: v6.24.1
npm_package_last_updated_on: Latest version published 5 years ago
npm_package_description: This plugin transforms static class properties as well as properties declared with the property initializer syntax
github_link: https://github.com/babel/babel
repo_name: babel
npm_link: https://www.npmjs.com/package/babel-plugin-transform-class-properties
install_command: npm install babel-plugin-transform-class-properties
popularity_dependents: 21.16K
popularity_github_stars: 40.05K
popularity_forks: 5.12K
popularity_badge: High
maintenance_open_issues: 619
maintenance_open_prs: 148
maintenance_latest_release: 5 years ago
