---
layout: default
npm_package_name: discord-spoiler-bot
npm_package_version: v2.0.6
npm_package_last_updated_on: Latest version published 4 years ago
npm_package_description: A bot for Discord that replaces spoiler messages with GIFs that reveal content on hover.
github_link: https://github.com/TimboKZ/discord-spoiler-bot
repo_name: discord-spoiler-bot
npm_link: https://www.npmjs.com/package/discord-spoiler-bot
install_command: npm install discord-spoiler-bot
popularity_dependents: 1
popularity_github_stars: 64
popularity_forks: 22
