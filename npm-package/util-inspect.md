---
layout: default
npm_package_name: util-inspect
npm_package_version: v0.1.8
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: cross-browser node.js `util.inspect`
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/util-inspect
install_command: npm install util-inspect
