---
layout: default
npm_package_name: react-native-background-timer
npm_package_version: v2.4.1
npm_package_last_updated_on: Latest version published 1 year ago
npm_package_description: Emit event periodically (even when app is in the background)
github_link: https://github.com/ocetnik/react-native-background-timer
repo_name: react-native-background-timer
npm_link: https://www.npmjs.com/package/react-native-background-timer
install_command: npm install react-native-background-timer
popularity_dependents: 25
popularity_github_stars: 1.29K
