---
layout: default
npm_package_name: typedi-no-dynamic-require
npm_package_version: v0.2.0
npm_package_last_updated_on: Latest version published 4 years ago
npm_package_description: Dependency injection for TypeScript
github_link: https://github.com/typestack/typedi
repo_name: typedi
npm_link: https://www.npmjs.com/package/typedi-no-dynamic-require
install_command: npm install typedi-no-dynamic-require
popularity_dependents: 1
popularity_github_stars: 2.79K
popularity_forks: 135
