---
layout: default
npm_package_name: eslint-config-rackt
npm_package_version: v1.1.1
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: Shareable eslint config for rackt repos
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/eslint-config-rackt
install_command: npm install eslint-config-rackt
