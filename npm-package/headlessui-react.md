---
layout: default
npm_package_name: headlessui-react
npm_package_version: v1.4.2
npm_package_last_updated_on: Latest version published 18 days ago
npm_package_description: A set of completely unstyled, fully accessible UI components for React, designed to integrate beautifully with Tailwind CSS.
github_link: https://github.com/tailwindlabs/headlessui
repo_name: headlessui
npm_link: https://www.npmjs.com/package/@headlessui/react
install_command: npm install @headlessui/react
popularity_dependents: 0
popularity_github_stars: 11.91K
popularity_forks: 409
popularity_badge: High
maintenance_open_issues: 67
maintenance_open_prs: 13
maintenance_latest_release: 18 days ago
maintenance_last_commit: 18 days ago
