---
layout: default
npm_package_name: truffle-config
npm_package_version: v1.1.20
npm_package_last_updated_on: Latest version published 2 years ago
npm_package_description: Utility for interacting with truffle-config.js files
github_link: https://github.com/trufflesuite/truffle
repo_name: truffle
npm_link: https://www.npmjs.com/package/truffle-config
install_command: npm install truffle-config
