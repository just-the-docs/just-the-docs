---
layout: default
npm_package_name: node-ffi
npm_package_version: v0.5.7
npm_package_last_updated_on: Latest version published 9 years ago
npm_package_description: A foreign function interface (FFI) for Node.js
github_link: https://github.com/node-ffi/node-ffi
repo_name: node-ffi
npm_link: https://www.npmjs.com/package/node-ffi
install_command: npm install node-ffi
popularity_dependents: 502
popularity_github_stars: 3.8K
popularity_forks: 420
popularity_badge: Small
maintenance_open_issues: 214
...
basic_node_compatibility: Greater/=0.6.0
basic_age: 11 years
basic_versions: 21
basic_dist_tags: 1
basic_maintainers: 2
