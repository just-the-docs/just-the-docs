---
layout: default
npm_package_name: uriname
npm_package_version: v0.3.1
npm_package_last_updated_on: Latest version published 5 months ago
npm_package_description: URI Safe Name from string Node.js
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/uriname
install_command: npm install uriname
