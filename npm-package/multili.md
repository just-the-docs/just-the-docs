---
layout: default
npm_package_name: multili
npm_package_version: v1.1.0
npm_package_last_updated_on: Latest version published 5 years ago
npm_package_description: Function to remove indentation in multi-lines template literals (string) based on the indented line.
github_link: https://github.com/MoOx/multili
repo_name: multili
npm_link: https://www.npmjs.com/package/multili
install_command: npm install multili
