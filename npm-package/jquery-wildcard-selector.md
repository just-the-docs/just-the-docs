---
layout: default
npm_package_name: jquery-wildcard-selector
npm_package_version: v1.0.1
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: Extending jquery selection to allow a way of selecting DOM elements by attributes with wildcards
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/jquery-wildcard-selector
install_command: npm install jquery-wildcard-selector
