---
layout: default
npm_package_name: p-queue-es5
npm_package_version: v6.0.2
npm_package_last_updated_on: Latest version published 2 years ago
npm_package_description: Promise queue with concurrency control
github_link: https://github.com/sindresorhus/p-queue
repo_name: p-queue
npm_link: https://www.npmjs.com/package/p-queue-es5
install_command: npm install p-queue-es5
popularity_dependents: 0
popularity_github_stars: 1.85K
popularity_forks: 131
