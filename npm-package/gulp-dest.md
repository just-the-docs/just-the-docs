---
layout: default
npm_package_name: gulp-dest
npm_package_version: v0.2.3
npm_package_last_updated_on: Latest version published 6 years ago
npm_package_description: Gulp plugin for easily defining destination paths using path variables.
github_link: https://github.com/jonschlinkert/gulp-dest
repo_name: gulp-dest
npm_link: https://www.npmjs.com/package/gulp-dest
install_command: npm install gulp-dest
