---
layout: default
npm_package_name: npm-install-missing
npm_package_version: v0.1.4
npm_package_last_updated_on: Latest version published 8 years ago
npm_package_description: This module will attempt to reinstall any missing dependencies.  It can be called via the command line or used programmatically.
github_link: https://github.com/AlexCline/npm-install-missing
repo_name: npm-install-missing
npm_link: https://www.npmjs.com/package/npm-install-missing
install_command: npm install npm-install-missing
popularity_dependents: 2
popularity_github_stars: 54
popularity_forks: 6
popularity_badge: Small
maintenance_open_issues: 0
maintenance_open_prs: 1
maintenance_latest_release: 8 years ago
maintenance_last_commit: 8 years ago
...
basic_node_compatibility: Greater/= 0.9.x
basic_age: 8 years
basic_versions: 6
basic_dist_tags: 1
basic_maintainers: 1
