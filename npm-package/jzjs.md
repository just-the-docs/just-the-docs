---
layout: default
npm_package_name: jzjs
npm_package_version: v2.0.2
npm_package_last_updated_on: Latest version published 2 years ago
npm_package_description: 一个轻量、简单的弹窗插件
github_link: https://github.com/netnr/jz
repo_name:
npm_link: https://www.npmjs.com/package/jzjs
install_command: npm install jzjs
