---
layout: default
npm_package_name: adm-zip
npm_package_version: v0.5.9
npm_package_last_updated_on: Latest version published 2 months ago
npm_package_description: Javascript implementation of zip for nodejs with support for electron original-fs. Allows user to create or extract zip files both in memory or to/from disk
github_link: https://github.com/cthackers/adm-zip
repo_name: adm-zip
npm_link: https://www.npmjs.com/package/adm-zip
install_command: npm install adm-zip
popularity_dependents: 1.91K
popularity_github_stars: 1.52K
popularity_forks: 330
popularity_badge: High
maintenance_open_issues: 123
...
basic_node_compatibility: Greater/=6.0
basic_age: 10 years
basic_versions: 34
basic_dist_tags: 1
basic_maintainers: 1
