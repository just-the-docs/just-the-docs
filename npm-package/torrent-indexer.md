---
layout: default
npm_package_name: torrent-indexer
npm_package_version: v1.2.1
npm_package_last_updated_on: Latest version published 2 years ago
npm_package_description: Yet another node.js torrent scraper based on seek-torrent but made especially for movies, series, anime and music (scrape from 1337x, eztv, limetorrents, rarbg, skytorrents, torrentproject, yts and zooqle)
github_link: https://github.com/sayem314/torrent-indexer
repo_name: torrent-indexer
npm_link: https://www.npmjs.com/package/torrent-indexer
install_command: npm install torrent-indexer
popularity_dependents: 1
popularity_github_stars: 46
popularity_forks: 10
