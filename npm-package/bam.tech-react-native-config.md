---
layout: default
npm_package_name: bam.tech-react-native-config
npm_package_version: v1.4.5
npm_package_last_updated_on: Latest version published 14 days ago
npm_package_description: Expose config variables to React Native apps
github_link: https://github.com/bamlab/react-native-config
repo_name: react-native-config
npm_link: https://www.npmjs.com/package/@bam.tech/react-native-config
install_command: npm install @bam.tech/react-native-config
