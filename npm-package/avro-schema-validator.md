---
layout: default
npm_package_name: avro-schema-validator
npm_package_version: v0.3.0
npm_package_last_updated_on: Latest version published 3 years ago
npm_package_description: A tool to infer AVRO schema's from JSON messages, and to validate it.
github_link: https://github.com/DRIVER-EU/avro-schemas
repo_name: avro-schemas
npm_link: https://www.npmjs.com/package/avro-schema-validator
install_command: npm install avro-schema-validator
