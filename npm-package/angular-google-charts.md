---
layout: default
npm_package_name: angular-google-charts
npm_package_version: v2.2.2
npm_package_last_updated_on: Latest version published 6 months ago
npm_package_description: A wrapper for the Google Charts library written with Angular
github_link: https://github.com/FERNman/angular-google-charts
repo_name: angular-google-charts
npm_link: https://www.npmjs.com/package/angular-google-charts
install_command: npm install angular-google-charts
popularity_dependents: 4
popularity_github_stars: 221
popularity_forks: 69
