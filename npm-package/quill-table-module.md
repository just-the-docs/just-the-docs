---
layout: default
npm_package_name: quill-table-module
npm_package_version: v1.0.1
npm_package_last_updated_on: Latest version published 3 years ago
npm_package_description: Table functionality in QuillJS using Containers.
github_link: https://github.com/paweldyminski/quill-table
repo_name: quill-table
npm_link: https://www.npmjs.com/package/quill-table-module
install_command: npm install quill-table-module
