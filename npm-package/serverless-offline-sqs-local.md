---
layout: default
npm_package_name: serverless-offline-sqs-local
npm_package_version: v2.1.0
npm_package_last_updated_on: Latest version published 1 year ago
npm_package_description: Emulate AWS λ and SQS locally when developing your Serverless project
github_link: https://github.com/CoorpAcademy/serverless-plugins
repo_name: serverless-plugins
npm_link: https://www.npmjs.com/package/serverless-offline-sqs-local
install_command: npm install serverless-offline-sqs-local
popularity_dependents: 3
popularity_github_stars: 157
popularity_forks: 101
popularity_badge: Limited
maintenance_open_issues: 47
maintenance_open_prs: 23
maintenance_latest_release: 1 year ago
maintenance_last_commit: 19 days ago
