---
layout: default
npm_package_name: connected-react-router
npm_package_version: v6.9.1
npm_package_last_updated_on: Latest version published 9 months ago
npm_package_description: A Redux binding for React Router v4 and v5
github_link: https://github.com/supasate/connected-react-router
repo_name: connected-react-router
npm_link: https://www.npmjs.com/package/connected-react-router
install_command: npm install connected-react-router
popularity_dependents: 644
popularity_github_stars: 4.62K
popularity_forks: 561
