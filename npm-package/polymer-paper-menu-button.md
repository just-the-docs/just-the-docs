---
layout: default
npm_package_name: polymer-paper-menu-button
npm_package_version: v3.1.0
npm_package_last_updated_on: Latest version published 9 months ago
npm_package_description: A material design element that composes a trigger and a dropdown menu
github_link: https://github.com/PolymerElements/paper-menu-button
repo_name: paper-menu-button
npm_link: https://www.npmjs.com/package/@polymer/paper-menu-button
install_command: npm install @polymer/paper-menu-button
popularity_dependents: 108
popularity_github_stars: 25
popularity_forks: 47
popularity_badge: Small
maintenance_open_issues: 40
...
basic_versions: 34
basic_dist_tags: 3
basic_maintainers: 11
basic_dependencies: 7 Direct
basic_install_size: 54.2 kB
basic_files: 12
downloads: 7762
contributors: 30
nav_exclude: true
