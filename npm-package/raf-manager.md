---
layout: default
npm_package_name: raf-manager
npm_package_version: v0.3.0
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: RAFManager is a simple requestAnimationFrame animation manager.
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/raf-manager
install_command: npm install raf-manager
