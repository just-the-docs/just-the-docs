---
layout: default
npm_package_name: clipay
npm_package_version: v0.0.5
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: send and receive payments with the command line
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/clipay
install_command: npm install clipay
