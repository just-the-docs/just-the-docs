---
layout: default
npm_package_name: blue-widgets
npm_package_version: v3.0.0
npm_package_last_updated_on: Latest version published 3 years ago
npm_package_description: A class-based widget library for adding complex javascript functionality to existing DOM elements
github_link: https://github.com/bluegrassdigital/blue-widgets
repo_name: blue-widgets
npm_link: https://www.npmjs.com/package/blue-widgets
install_command: npm install blue-widgets
