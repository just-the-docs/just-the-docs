---
layout: default
npm_package_name: thanos-js
npm_package_version: v0.0.11
npm_package_last_updated_on: Latest version published 3 years ago
npm_package_description: A casual (but dangerous) package that will let Thanos snap fingers and delete random files inside a directory
github_link: https://github.com/anandundavia/thanos-js
repo_name: thanos-js
npm_link: https://www.npmjs.com/package/thanos-js
install_command: npm install thanos-js
popularity_dependents: 0
popularity_github_stars: 290
popularity_forks: 10
