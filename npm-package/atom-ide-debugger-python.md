---
layout: default
npm_package_name: atom-ide-debugger-python
npm_package_version: v0.7.2
npm_package_last_updated_on: Latest version published 3 years ago
npm_package_description: Python Debugger for Atom IDE.
github_link: https://github.com/facebookarchive/nuclide
repo_name: nuclide
npm_link: https://www.npmjs.com/package/atom-ide-debugger-python
install_command: npm install atom-ide-debugger-python
popularity_dependents: 1
popularity_github_stars: 7.88K
popularity_forks: 759
popularity_badge: Small
maintenance_open_issues: 387
