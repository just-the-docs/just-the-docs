---
layout: default
npm_package_name: sync-request
npm_package_version: v6.1.0
npm_package_last_updated_on: Latest version published 3 years ago
npm_package_description: Make synchronous web requests
github_link: https://github.com/ForbesLindesay/sync-request
repo_name: sync-request
npm_link: https://www.npmjs.com/package/sync-request
install_command: npm install sync-request
popularity_dependents: 975
popularity_github_stars: 300
popularity_forks: 41
