---
layout: default
npm_package_name: ifcom
npm_package_version: v1.0.41
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: An Observable based wrapper around iframe postMessage
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/ifcom
install_command: npm install ifcom
