---
layout: default
npm_package_name: jweather
npm_package_version: v1.1.0
npm_package_last_updated_on: Latest version published 5 years ago
npm_package_description: A jQuery plugin used to display the current weather of any city using Yahoo-Weather.
github_link: https://github.com/IvanSotelo/JWeather
repo_name: JWeather
npm_link: https://www.npmjs.com/package/jweather
install_command: npm install jweather
