---
layout: default
npm_package_name: discord-ban-list
npm_package_version: v1.0.6
npm_package_last_updated_on: Latest version published 5 years ago
npm_package_description: Check if a certain Discord user ID is listed in the global ban list
github_link: https://github.com/austinhuang0131/discord-ban-list-node
repo_name: discord-ban-list-node
npm_link: https://www.npmjs.com/package/discord-ban-list
install_command: npm install discord-ban-list
