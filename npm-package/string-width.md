---
layout: default
npm_package_name: string-width
npm_package_version: v5.0.1
npm_package_last_updated_on: Latest version published 2 months ago
npm_package_description: Get the visual width of a string - the number of columns required to display it
github_link: https://github.com/sindresorhus/string-width
repo_name: string-width
npm_link: https://www.npmjs.com/package/string-width
install_command: npm install string-width
popularity_dependents: 828
popularity_github_stars: 285
popularity_forks: 21
popularity_badge: High
maintenance_open_issues: 3
