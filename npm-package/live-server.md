---
layout: default
npm_package_name: live-server
npm_package_version: v1.2.1
npm_package_last_updated_on: Latest version published 3 years ago
npm_package_description: simple development http server with live reload capability
github_link: https://github.com/tapio/live-server
repo_name: live-server
npm_link: https://www.npmjs.com/package/live-server
install_command: npm install live-server
popularity_dependents: 1.52K
popularity_github_stars: 3.75K
popularity_forks: 438
popularity_badge: High
maintenance_open_issues: 128
maintenance_open_prs: 53
