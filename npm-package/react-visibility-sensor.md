---
layout: default
npm_package_name: react-visibility-sensor
npm_package_version: v5.1.1
npm_package_last_updated_on: Latest version published 2 years ago
npm_package_description: Sensor component for React that notifies you when it goes in or out of the window viewport.
github_link: https://github.com/joshwnj/react-visibility-sensor
repo_name: react-visibility-sensor
npm_link: https://www.npmjs.com/package/react-visibility-sensor
install_command: npm install react-visibility-sensor
popularity_dependents: 227
popularity_github_stars: 2.16K
popularity_forks: 192
popularity_badge: High
maintenance_open_issues: 58
maintenance_open_prs: 17
