---
layout: default
npm_package_name: selectn
npm_package_version: v1.1.2
npm_package_last_updated_on: Latest version published 5 years ago
npm_package_description: Curried property accessor function that resolves deeply-nested object properties via dot/bracket-notation string path while mitigating TypeErrors via friendly and composable API.
github_link: https://github.com/wilmoore/selectn.js
repo_name: selectn.js
npm_link: https://www.npmjs.com/package/selectn
install_command: npm install selectn
popularity_dependents: 1
popularity_github_stars: 189
popularity_forks: 16
