---
layout: default
npm_package_name: next-routes
npm_package_version: v1.4.2
npm_package_last_updated_on: Latest version published 4 years ago
npm_package_description: Easy to use universal dynamic routes for Next.js
github_link: https://github.com/fridays/next-routes
repo_name: next-routes
npm_link: https://www.npmjs.com/package/next-routes
install_command: npm install next-routes
popularity_dependents: 89
popularity_github_stars: 2.35K
popularity_forks: 225
