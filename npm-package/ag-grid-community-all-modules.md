---
layout: default
npm_package_name: ag-grid-community-all-modules
npm_package_version: v26.2.0
npm_package_last_updated_on: Latest version published 18 days ago
npm_package_description: Advanced Data Grid / Data Table supporting Javascript / React / AngularJS / Web Components
github_link: https://github.com/ag-grid/ag-grid
repo_name: ag-grid
npm_link: https://www.npmjs.com/package/@ag-grid-community/all-modules
install_command: npm install @ag-grid-community/all-modules
popularity_dependents: 26
popularity_github_stars: 7.81K
popularity_forks: 1.38K
