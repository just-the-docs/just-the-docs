---
layout: default
npm_package_name: nbxx-nb-froala
npm_package_version: v2.9.8001
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: ngx froala base
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/@nbxx/nb-froala
install_command: npm install @nbxx/nb-froala
