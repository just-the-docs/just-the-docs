---
layout: default
npm_package_name: node-ecole-directe
npm_package_version: v1.3.4
npm_package_last_updated_on: Latest version published 10 months ago
npm_package_description: API pour intéragir avec Ecole Directe
github_link: https://github.com/Androz2091/node-ecole-directe
repo_name: node-ecole-directe
npm_link: https://www.npmjs.com/package/node-ecole-directe
install_command: npm install node-ecole-directe
