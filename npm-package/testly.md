---
layout: default
npm_package_name: testly
npm_package_version: v2.1.9
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: Testly is a testing library built for simplicity and usefulness.
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/testly
install_command: npm install testly
