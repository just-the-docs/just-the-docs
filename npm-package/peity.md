---
layout: default
npm_package_name: peity
npm_package_version: v3.3.0
npm_package_last_updated_on: Latest version published 4 years ago
npm_package_description: Peity is a jQuery plugin that converts an element's content into a mini `svg` pie, line or bar chart.
github_link: https://github.com/benpickles/peity
repo_name: peity
npm_link: https://www.npmjs.com/package/peity
install_command: npm install peity
popularity_dependents: 14
popularity_github_stars: 4.21K
popularity_forks: 412
