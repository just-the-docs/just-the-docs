---
layout: default
npm_package_name: openvgdb
npm_package_version: v1.0.0
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: JSON version of openvgdb for JavaScript usage.
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/openvgdb
install_command: npm install openvgdb
