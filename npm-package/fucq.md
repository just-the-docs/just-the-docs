---
layout: default
npm_package_name: fucq
npm_package_version: v0.4.1
npm_package_last_updated_on: Latest version published 7 years ago
npm_package_description: Fixed-capacity FIFO queue that enforces uniqueness among elements, using Redis.
github_link: https://github.com/why-jay/fucq
repo_name: fucq
npm_link: https://www.npmjs.com/package/fucq
install_command: npm install fucq
