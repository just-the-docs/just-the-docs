---
layout: default
npm_package_name: digix-doxity
npm_package_version: v0.5.2
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: Documentation Generator for Solidity Contracts
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/@digix/doxity
install_command: npm install @digix/doxity
