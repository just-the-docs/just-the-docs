---
layout: default
npm_package_name: vuip-router
npm_package_version: v1.0.3
npm_package_last_updated_on: Latest version published 1 year ago
npm_package_description: vuip SPA 应用简易路由实现
github_link: https://github.com/hhq183727243/vuip-router
repo_name: vuip-router
npm_link: https://www.npmjs.com/package/vuip-router
install_command: npm install vuip-router
