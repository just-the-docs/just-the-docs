---
layout: default
npm_package_name: gitzone-tstest
npm_package_version: v1.0.60
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: a test utility to run tests that match test/**/*.ts
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/@gitzone/tstest
install_command: npm install @gitzone/tstest
...
maintenance_latest_release: 25 days ago
