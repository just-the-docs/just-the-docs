---
layout: default
npm_package_name: i9n
npm_package_version: v0.0.2
npm_package_last_updated_on: Latest version published 3 years ago
npm_package_description: Ruin words with i18nization (no relation to actual internationalization)
github_link: https://github.com/ifo/i9n
repo_name: i9n
npm_link: https://www.npmjs.com/package/i9n
install_command: npm install i9n
