---
layout: default
npm_package_name: ah-tdp-js-connector-plugin
npm_package_version: v1.0.0
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: An actionhero plugin provides an actionhero(/primus) javascript client instance with local caching and server-side configuration
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/ah-tdp-js-connector-plugin
install_command: npm install ah-tdp-js-connector-plugin
