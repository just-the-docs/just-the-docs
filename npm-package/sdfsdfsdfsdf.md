---
layout: default
npm_package_name: sdfsdfsdfsdf
npm_package_version: v3.2.3
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: Simple calculator API hosted on APIMATIC
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/sdfsdfsdfsdf
install_command: npm install sdfsdfsdfsdf
