---
layout: default
npm_package_name: tar.gz
npm_package_version: v1.0.7
npm_package_last_updated_on: Latest version published 4 years ago
npm_package_description: ⚠️ DEPRECATED ⚠️ Pure javascript tarball tools for Node.js
github_link: https://github.com/alanhoff/node-tar.gz
repo_name: node-tar.gz
npm_link: https://www.npmjs.com/package/tar.gz
install_command: npm install tar.gz
popularity_dependents: 284
popularity_github_stars: 158
popularity_forks: 34
...
maintenance_badge: Inactive & Depricated
