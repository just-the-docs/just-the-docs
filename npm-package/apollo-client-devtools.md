---
layout: default
npm_package_name: apollo-client-devtools
npm_package_version: v4.0.0
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: Developer tools for Apollo Client, with Studio Explorer integration, cache inspection, and query watching.
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/apollo-client-devtools
install_command: npm install apollo-client-devtools
