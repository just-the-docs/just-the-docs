---
layout: default
npm_package_name: activedirectory
npm_package_version: v0.7.2
npm_package_last_updated_on: Latest version published 6 years ago
npm_package_description: ActiveDirectory is an ldapjs client for authN (authentication) and authZ (authorization) for Microsoft Active Directory with range retrieval support for large Active Directory installations.
github_link: https://github.com/gheeres/node-activedirectory
repo_name: node-activedirectory
npm_link: https://www.npmjs.com/package/activedirectory
install_command: npm install activedirectory
popularity_dependents: 1
popularity_github_stars: 519
popularity_forks: 161
popularity_badge: Small
maintenance_open_issues: 82
maintenance_open_prs: 12
maintenance_latest_release: 6 years ago
maintenance_last_commit: 6 years ago
...
basic_node_compatibility: Greater/=0.8
basic_age: 8 years
basic_versions: 30
basic_dist_tags: 1
basic_maintainers: 1
