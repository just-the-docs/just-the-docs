---
layout: default
npm_package_name: bash.im
npm_package_version: v1.1.1
npm_package_last_updated_on: Latest version published 3 years ago
npm_package_description: A package to get random quote from bash.im
github_link: https://github.com/nitreojs/bash.im
repo_name:
npm_link: https://www.npmjs.com/package/bash.im
install_command: npm install bash.im
