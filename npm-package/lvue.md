---
layout: default
npm_package_name: lvue
npm_package_version: v0.2.3
npm_package_last_updated_on: Latest version published 7 months ago
npm_package_description: 基于vue3.0,对element-plus二次封装的组件库
github_link: https://github.com/longshao5520/lvue
repo_name: lvue
npm_link: https://www.npmjs.com/package/lvue
install_command: npm install lvue
