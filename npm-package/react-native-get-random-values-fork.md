---
layout: default
npm_package_name: react-native-get-random-values-fork
npm_package_version: v1.1.3
npm_package_last_updated_on: Latest version published 2 years ago
npm_package_description: A small implementation of `getRandomValues` for React Native.
github_link: https://github.com/hzz780/react-native-get-random-values
repo_name: react-native-get-random-values
npm_link: https://www.npmjs.com/package/react-native-get-random-values-fork
install_command: npm install react-native-get-random-values-fork
