---
layout: default
npm_package_name: react-native-action-button
npm_package_version: v2.8.5
npm_package_last_updated_on: Latest version published 3 years ago
npm_package_description: customizable multi-action-button component for react-native
github_link: https://github.com/mastermoo/react-native-action-button
repo_name: react-native-action-button
npm_link: https://www.npmjs.com/package/react-native-action-button
install_command: npm install react-native-action-button
popularity_dependents: 10
popularity_github_stars: 2.41K
popularity_forks: 535
popularity_badge: Medium
maintenance_open_issues: 73
