---
layout: default
npm_package_name: angular-ios9-uiwebview-patch
npm_package_version: v1.1.1
npm_package_last_updated_on: Latest version published 6 years ago
npm_package_description: Bower and NPM support for IgorMinar's iOS9 Patch for Angular 1.2.0-1.4.5 - https://gist.github.com/IgorMinar/863acd413e3925bf282c
github_link: https://github.com/azaslavsky/angular-ios9-uiwebview-patch
repo_name: angular-ios9-uiwebview-patch
npm_link: https://www.npmjs.com/package/angular-ios9-uiwebview-patch
install_command: npm install angular-ios9-uiwebview-patch
