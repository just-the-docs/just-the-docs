---
layout: default
npm_package_name: flowjs-ngx-flow
npm_package_version: v0.4.6
npm_package_last_updated_on: Latest version published 10 months ago
npm_package_description: flow.js file upload for angular
github_link: https://github.com/flowjs/ngx-flow
repo_name: ngx-flow
npm_link: https://www.npmjs.com/package/@flowjs/ngx-flow
install_command: npm install @flowjs/ngx-flow
