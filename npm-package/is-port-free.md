---
layout: default
npm_package_name: is-port-free
npm_package_version: v1.0.7
npm_package_last_updated_on: Latest version published 4 years ago
npm_package_description: A simple node module to check if a TCP port is free on the local machine.
github_link: https://github.com/john-doherty/is-port-free
repo_name: is-port-free
npm_link: https://www.npmjs.com/package/is-port-free
install_command: npm install is-port-free
