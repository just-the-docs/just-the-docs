---
layout: default
npm_package_name: jquery-ui
npm_package_version: v1.13.0
npm_package_last_updated_on: Latest version published 2 months ago
npm_package_description: A curated set of user interface interactions, effects, widgets, and themes built on top of the jQuery JavaScript Library.
github_link: https://github.com/jquery/jquery-ui
repo_name: jquery-ui
npm_link: https://www.npmjs.com/package/jquery-ui
install_command: npm install jquery-ui
popularity_dependents: 781
popularity_github_stars: 10.99K
popularity_forks: 5.32K
popularity_badge: High
maintenance_open_issues: 23
maintenance_open_prs: 34
