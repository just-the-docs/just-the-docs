---
layout: default
npm_package_name: brreg
npm_package_version: v5.0.6
npm_package_last_updated_on: Latest version published 12 days ago
npm_package_description: Look up data from the Norwegian Entity Registry
github_link: https://github.com/zrrrzzt/brreg
repo_name: brreg
npm_link: https://www.npmjs.com/package/brreg
install_command: npm install brreg
...
basic_node_compatibility: Greater/=14.18.1
basic_age: 8 years
basic_versions: 22
basic_dist_tags: 1
basic_maintainers: 1
basic_dependencies: 1 Direct
basic_install_size: 10.4 kB
basic_files: 13
downloads: 40
contributors: 4
nav_exclude: true
