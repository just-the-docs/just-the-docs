---
layout: default
npm_package_name: smtp-server
npm_package_version: v3.9.0
npm_package_last_updated_on: Latest version published 6 months ago
npm_package_description: Create custom SMTP servers on the fly
github_link: https://github.com/nodemailer/smtp-server
repo_name: smtp-server
npm_link: https://www.npmjs.com/package/smtp-server
install_command: npm install smtp-server
popularity_dependents: 132
popularity_github_stars: 698
popularity_forks: 143
