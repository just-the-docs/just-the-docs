---
layout: default
npm_package_name: labelary
npm_package_version: v1.3.0
npm_package_last_updated_on: Latest version published 6 months ago
npm_package_description: Create PDF's or PNG's from ZPL labels via the Labelary API on the CLI.
github_link: https://github.com/Justintime50/labelary
repo_name: labelary
npm_link: https://www.npmjs.com/package/labelary
install_command: npm install labelary
