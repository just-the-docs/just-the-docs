---
layout: default
npm_package_name: angular2-http-file-upload
npm_package_version: v1.0.8
npm_package_last_updated_on: Latest version published 4 years ago
npm_package_description: Library to support HTTP file uploads for Angular 2
github_link: https://github.com/j-zeng/angular2-http-file-upload
repo_name: angular2-http-file-upload
npm_link: https://www.npmjs.com/package/angular2-http-file-upload
install_command: npm install angular2-http-file-upload
popularity_dependents: 10
popularity_github_stars: 12
popularity_forks: 13
