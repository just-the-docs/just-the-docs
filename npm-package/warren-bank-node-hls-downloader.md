---
layout: default
npm_package_name: warren-bank-node-hls-downloader
npm_package_version: v4.0.5
npm_package_last_updated_on: Latest version published 11 months ago
npm_package_description: Command-line utility for downloading an offline copy of an HLS video stream.
github_link: https://github.com/warren-bank/node-hls-downloader
repo_name: node-hls-downloader
npm_link: https://www.npmjs.com/package/@warren-bank/node-hls-downloader
install_command: npm install @warren-bank/node-hls-downloader
popularity_dependents: 4
popularity_github_stars: 9
popularity_forks: 2
popularity_badge: Limited
maintenance_open_issues: 1
maintenance_open_prs: 0
maintenance_latest_release: 11 months ago
maintenance_last_commit: 11 months ago
