---
layout: default
npm_package_name: gsap
npm_package_version: v3.8.0
npm_package_last_updated_on: Latest version published 2 months ago
npm_package_description: GreenSock's GSAP JavaScript animation library (including Draggable).
github_link: https://github.com/greensock/GSAP
repo_name: GSAP
npm_link: https://www.npmjs.com/package/gsap
install_command: npm install gsap
popularity_dependents: 864
popularity_github_stars: 13.3K
popularity_forks: 1.5K
