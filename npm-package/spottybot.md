---
layout: default
npm_package_name: spottybot
npm_package_version: v1.0.4
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: A service for collaborating on Spotify playlists through slack
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/spottybot
install_command: npm install spottybot
