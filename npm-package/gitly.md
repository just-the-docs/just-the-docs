---
layout: default
npm_package_name: gitly
npm_package_version: v2.1.5
npm_package_last_updated_on: Latest version published 3 months ago
npm_package_description: An API to download and/or extract git repositories
github_link: https://github.com/iwatakeshi/gitly
repo_name: gitly
npm_link: https://www.npmjs.com/package/gitly
install_command: npm install gitly
