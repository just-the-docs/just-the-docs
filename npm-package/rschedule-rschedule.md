---
layout: default
npm_package_name: rschedule-rschedule
npm_package_version: v0.11.6
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: A typescript library for working with recurring dates and events.
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/@rschedule/rschedule
install_command: npm install @rschedule/rschedule
