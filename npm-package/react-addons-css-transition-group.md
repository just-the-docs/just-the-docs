---
layout: default
npm_package_name: react-addons-css-transition-group
npm_package_version: v15.6.2
npm_package_last_updated_on: Latest version published 4 years ago
npm_package_description: The code in this package has moved. We recommend you to use `CSSTransitionGroup` from [`react-transition-group`](https://github.com/reactjs/react-transition-group) instead.
github_link: https://github.com/facebook/react
repo_name: react
npm_link: https://www.npmjs.com/package/react-addons-css-transition-group
install_command: npm install react-addons-css-transition-group
popularity_dependents: 156.9K
popularity_github_stars: 178.74K
popularity_forks: 36.22K
popularity_badge: High
maintenance_open_issues: 665
maintenance_open_prs: 231
maintenance_latest_release: 4 years ago
maintenance_last_commit: 11 hours ago
