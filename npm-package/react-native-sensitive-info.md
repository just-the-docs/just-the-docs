---
layout: default
npm_package_name: react-native-sensitive-info
npm_package_version: v5.5.8
npm_package_last_updated_on: Latest version published 1 year ago
npm_package_description: react-native-sensitive-info manages all data stored in Android Shared Preferences and iOS Keychain. You can set, get and delete keys/values using simple methods.
github_link: https://github.com/mCodex/react-native-sensitive-info
repo_name: react-native-sensitive-info
npm_link: https://www.npmjs.com/package/react-native-sensitive-info
install_command: npm install react-native-sensitive-info
popularity_dependents: 23
popularity_github_stars: 834
popularity_forks: 191
