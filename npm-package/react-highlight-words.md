---
layout: default
npm_package_name: react-highlight-words
npm_package_version: v0.17.0
npm_package_last_updated_on: Latest version published 11 months ago
npm_package_description: React component to highlight words within a larger body of text
github_link: https://github.com/bvaughn/react-highlight-words
repo_name: react-highlight-words
npm_link: https://www.npmjs.com/package/react-highlight-words
install_command: npm install react-highlight-words
popularity_dependents: 453
popularity_github_stars: 1.61K
popularity_forks: 151
popularity_badge: High
maintenance_open_issues: 0
maintenance_open_prs: 6
maintenance_latest_release: 11 months ago
