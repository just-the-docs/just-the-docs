---
layout: default
npm_package_name: npm-force-resolutions
npm_package_version: v0.0.10
npm_package_last_updated_on: Latest version published 9 months ago
npm_package_description: This packages modifies package-lock.json to force the installation of specific version of a transitive dependency (dependency of dependency), similar to yarn's [selective dependency resolutions](https://yarnpkg.com/lang/en/docs/selective-version-resolutio
github_link: https://github.com/rogeriochaves/npm-force-resolutions
repo_name: npm-force-resolutions
npm_link: https://www.npmjs.com/package/npm-force-resolutions
install_command: npm install npm-force-resolutions
popularity_dependents: 60
popularity_github_stars: 443
popularity_forks: 22
popularity_badge: High
maintenance_open_issues: 25
maintenance_open_prs: 3
maintenance_latest_release: 9 months ago
maintenance_last_commit: 9 months ago
...
basic_dist_tags: 1
basic_maintainers: 1
basic_dependencies: 3 Direct
basic_install_size: 15.3 MB
basic_files: 443
downloads: 211148
contributors: 2
nav_exclude: true
