---
layout: default
npm_package_name: eslint-plugin-import-order
npm_package_version: v2.1.4
npm_package_last_updated_on: Latest version published 6 years ago
npm_package_description: ESLint plugin to enforce the order of import/require statements.
github_link: https://github.com/jfmengels/eslint-plugin-import-order
repo_name: eslint-plugin-import-order
npm_link: https://www.npmjs.com/package/eslint-plugin-import-order
install_command: npm install eslint-plugin-import-order
popularity_dependents: 48
popularity_github_stars: 43
popularity_forks: 3
...
basic_node_compatibility: Greater/=0.10.0
basic_age: 6 years
basic_versions: 9
basic_dist_tags: 1
basic_maintainers: 1
