---
layout: default
npm_package_name: asdf-games
npm_package_version: v1.1.6
npm_package_last_updated_on: Latest version published is unknown
npm_package_description: Javascript gaming framework, based upon the framework made in the book HTML5 Games - Novice to Ninja by Sitepoint.
github_link: 
repo_name: 
npm_link: https://www.npmjs.com/package/asdf-games
install_command: npm install asdf-games
